...
namespace TcpIP
{
    class CTcpClient
    {
        ...
        /// 客户端连接尝试次数 
        /// </summary>
        private int nTryConnectCount = 2;

        /// <summary>
        /// 客户端初始连接服务器超时时间（毫秒）
        /// </summary>
        private int nTryInitialConnectTime = 100;
        /// <summary>
        /// 客户端初始连接服务器超时时间（毫秒）
        /// </summary>
        ...
        Thread[] thConnecttoServer = new Thread[4];
        /// <summary>
        /// 连接服务器
        /// </summary>
        ...
        private void ConnecttoServerTimeOut64(object sender)
        {
        ...
        private void ConnecttoServerTimeOut48(object sender)
        {
            ConnectServerParam param = (ConnectServerParam)sender;
            try
            {
        ...
        private void ConnecttoServerTimeOut32(object sender)
        {
            ConnectServerParam param = (ConnectServerParam)sender;
            try
            {
