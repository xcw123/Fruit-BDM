...
{
    public partial class StatisticsInfoForm4 : Form
    {
        private DataInterface dataInterface;
        private Boolean bIsSourceDB;
        private int currentSelectIndex;

        public int intPage = 0;             //打印等级表总页数
        ...
        private ResourceManager m_resourceManager = new ResourceManager(typeof(StatisticsInfoForm4));//创建Mainform资源管理
        ...
        public StatisticsInfoForm4()
        {
            InitializeComponent();
        }

        public StatisticsInfoForm4(DataInterface dataInterface1)
        {
        ...
        private void StatisticsInfoForm4_Load(object sender, EventArgs e)
        {
            //加载时默认选中TabPage1
            ...
            LvwFruitData.Columns.Add("WeightLimit", m_resourceManager.GetString("LblMainReportWeight.Text"));
            LvwFruitData.Columns["WeightLimit"].Width = 100; //100
            LvwFruitData.Columns["WeightLimit"].TextAlign = HorizontalAlignment.Center;
            ...
            LvwSizeOrWeightData.Columns.Add("WeightLimit", m_resourceManager.GetString("LblMainReportWeight.Text"));
            LvwSizeOrWeightData.Columns["WeightLimit"].Width = 100; //100
            LvwSizeOrWeightData.Columns["WeightLimit"].TextAlign = HorizontalAlignment.Center;
        ...
        private void currentSelectTabpage1()
        {
            ...
            UInt64 uMaxValueNumber = 0;//个数最大值 
            UInt64 uSumValueNumber = 0;//总个数
            UInt64 uMaxValueWeight = 0;//重量最大值
            UInt64 uSumValueWeight = 0;//总重量
            #endregion

            #region 界面设定
            if ((dataInterface.ExportSum - 1) * (DrawGraphProtocol.CylinderWidth * 2 + DrawGraphProtocol.CylinderSpace) +
                DrawGraphProtocol.CylinderWidth * 2 + DrawGraphProtocol.Module2RightDistance < tabPage1.Width)  //无需使用滚动条
            {
                bHaveHscrollBar = false;
                hScrollBar1.Visible = false;
                PicExport.Dock = DockStyle.Fill;
                CylinderHeight1 = DrawGraphProtocol.CylinderHeight2;
                leftRightSpace = (PicExport.Width - (dataInterface.ExportSum - 1) * (DrawGraphProtocol.CylinderWidth * 2 + DrawGraphProtocol.CylinderSpace) -
                    DrawGraphProtocol.CylinderWidth * 2 - DrawGraphProtocol.Module2RightDistance) / 2;
            }
            else  //需要使用滚动条
            {
                bHaveHscrollBar = true;
                PicExport.Width = (dataInterface.ExportSum - 1) * (DrawGraphProtocol.CylinderWidth * 2 + DrawGraphProtocol.CylinderSpace) +
                    DrawGraphProtocol.CylinderWidth * 2 + 2 * DrawGraphProtocol.LeftRightSpace + DrawGraphProtocol.Module2RightDistance;
            ...
            Brush BarBrush = new SolidBrush(DrawGraphProtocol.myBarBrush2);
            Brush BarBrushWeight = new SolidBrush(DrawGraphProtocol.myBarBrush3);

            #region 个数/重量/百分比 出口统计信息
            //"数量百分比"字样
            //g.DrawString("个数/重量/百分比", new Font(DrawGraphProtocol.Module1FontStyle, DrawGraphProtocol.Module1FontSize, FontStyle.Regular),
            ...
            #region 框 柱体1 柱体2 个数 重量
            //"颜色框"字样
            g1.DrawRectangle(new Pen(Color.Black), PicExport.Width - DrawGraphProtocol.Module2RightDistance, PicExport.Height / 2 - DrawGraphProtocol.Module2MiddleDistance,
                DrawGraphProtocol.Module2FrameWidth, DrawGraphProtocol.Module2FrameHeight);
            g1.FillRectangle(BarBrush, PicExport.Width - DrawGraphProtocol.Module2RightDistance + DrawGraphProtocol.Module2SmallGraphHorizontalSpace,
                PicExport.Height / 2 - DrawGraphProtocol.Module2MiddleDistance + DrawGraphProtocol.Module2SmallGraphVerticalSpace,
                DrawGraphProtocol.Module2SmallCylinderWidth, DrawGraphProtocol.Module2SmallCylinderHeight);
            g1.FillRectangle(BarBrushWeight, PicExport.Width - DrawGraphProtocol.Module2RightDistance + DrawGraphProtocol.Module2SmallGraphHorizontalSpace,
                PicExport.Height / 2 - DrawGraphProtocol.Module2MiddleDistance + DrawGraphProtocol.Module2SmallGraphVerticalSpace * 2 + DrawGraphProtocol.Module2SmallCylinderHeight,
                DrawGraphProtocol.Module2SmallCylinderWidth, DrawGraphProtocol.Module2SmallCylinderHeight);
            g1.DrawString(m_resourceManager.GetString("LblPieces.Text"), new Font(DrawGraphProtocol.Module2FontStyle, DrawGraphProtocol.Module2FontSize, FontStyle.Regular), currentBrush,
                PicExport.Width - DrawGraphProtocol.Module2RightDistance + DrawGraphProtocol.Module2SmallGraphHorizontalSpace + DrawGraphProtocol.Module2SmallCylinderWidth + DrawGraphProtocol.Module2FontHorizontalSpace,
                PicExport.Height / 2 - DrawGraphProtocol.Module2MiddleDistance + DrawGraphProtocol.Module2SmallGraphVerticalSpace + DrawGraphProtocol.Module2FontVerticalSpace);
            g1.DrawString(m_resourceManager.GetString("LblWeight.Text"), new Font(DrawGraphProtocol.Module2FontStyle, DrawGraphProtocol.Module2FontSize, FontStyle.Regular), currentBrush,
                PicExport.Width - DrawGraphProtocol.Module2RightDistance + DrawGraphProtocol.Module2SmallGraphHorizontalSpace + DrawGraphProtocol.Module2SmallCylinderWidth + DrawGraphProtocol.Module2FontHorizontalSpace,
                PicExport.Height / 2 - DrawGraphProtocol.Module2MiddleDistance + DrawGraphProtocol.Module2SmallGraphVerticalSpace + DrawGraphProtocol.Module2FontVerticalSpace +
                DrawGraphProtocol.Module2SmallGraphVerticalSpace + DrawGraphProtocol.Module2SmallCylinderHeight);
            #endregion

            #region 出口序号 （个数|重量）柱体 （个数|重量）个数 （个数|重量）百分比
            //"出口序号"字样  "柱体"图形显示  个数  百分比
            uMaxValueNumber = FunctionInterface.GetMaxValue(dataInterface.IoStStatistics.nExitCount);
            uSumValueNumber = FunctionInterface.GetSumValue(dataInterface.IoStStatistics.nExitCount);
            uMaxValueWeight = FunctionInterface.GetMaxValue(dataInterface.IoStStatistics.nExitWeightCount);
            uSumValueWeight = FunctionInterface.GetSumValue(dataInterface.IoStStatistics.nExitWeightCount);
            for (int i = 0; i < dataInterface.ExportSum; i++)
            {
                if (bHaveHscrollBar)  //有滚动条时
                {
                    ...
                    currentBrush, DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + DrawGraphProtocol.CylinderSpace), PicExport.Height - DrawGraphProtocol.Module4BottomDistance);

                    if (dataInterface.IoStStatistics.nExitCount[i] == 0)
                    {
                        //"柱体"个数图形显示
                        g1.FillRectangle(BarBrush, DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + DrawGraphProtocol.CylinderSpace),
                        ...
                        //"柱体"重量图形显示
                        g1.FillRectangle(BarBrushWeight, DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + DrawGraphProtocol.CylinderSpace) + DrawGraphProtocol.CylinderWidth,
                        PicExport.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.CylinderHeight4,
                        DrawGraphProtocol.CylinderWidth, DrawGraphProtocol.CylinderHeight4);
                    }
                    else
                    {
                        //"柱体"图形显示  个数
                        g1.FillRectangle(BarBrush, DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + DrawGraphProtocol.CylinderSpace),
                        PicExport.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - (int)(CylinderHeight1 * ((double)dataInterface.IoStStatistics.nExitCount[i] / uMaxValueNumber)),
                        DrawGraphProtocol.CylinderWidth, (int)(CylinderHeight1 * ((double)dataInterface.IoStStatistics.nExitCount[i] / uMaxValueNumber)));
                        //"柱体"重量图形显示
                        g1.FillRectangle(BarBrushWeight, DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + DrawGraphProtocol.CylinderSpace) + DrawGraphProtocol.CylinderWidth,
                        PicExport.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - (int)(CylinderHeight1 * ((double)dataInterface.IoStStatistics.nExitWeightCount[i] / uMaxValueWeight)),
                        DrawGraphProtocol.CylinderWidth, (int)(CylinderHeight1 * ((double)dataInterface.IoStStatistics.nExitWeightCount[i] / uMaxValueWeight)));

                        //显示"个数"值
                        if ((int)(CylinderHeight1 * ((double)dataInterface.IoStStatistics.nExitCount[i] / uMaxValueNumber)) > DrawGraphProtocol.StandardCylinderHeight)
                        {
                            g1.TranslateTransform(DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + DrawGraphProtocol.CylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance,
                        ...
                        else
                        {
                            g1.TranslateTransform(DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + DrawGraphProtocol.CylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance,
                            PicExport.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance-
                            (int)(CylinderHeight1 * ((double)dataInterface.IoStStatistics.nExitCount[i] / uMaxValueNumber)));
                            g1.RotateTransform(-90f);
                            g1.DrawString(dataInterface.IoStStatistics.nExitCount[i].ToString(),
                                new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
                            g1.ResetTransform();
                        ...
                        //显示"重量"值
                        if ((int)(CylinderHeight1 * ((double)dataInterface.IoStStatistics.nExitWeightCount[i] / uMaxValueWeight)) > DrawGraphProtocol.StandardCylinderHeight)
                        {
                            g1.TranslateTransform(DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + DrawGraphProtocol.CylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance + DrawGraphProtocol.CylinderWidth,
                            PicExport.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance);
                            g1.RotateTransform(-90f);
                            g1.DrawString(dataInterface.IoStStatistics.nExitWeightCount[i].ToString(),
                                new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
                            g1.ResetTransform();
                        }
                        else
                        {
                            g1.TranslateTransform(DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + DrawGraphProtocol.CylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance + DrawGraphProtocol.CylinderWidth,
                            PicExport.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance-
                            (int)(CylinderHeight1 * ((double)dataInterface.IoStStatistics.nExitWeightCount[i] / uMaxValueWeight)));
                            g1.RotateTransform(-90f);
                            g1.DrawString(dataInterface.IoStStatistics.nExitWeightCount[i].ToString(),
                                new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
                            g1.ResetTransform();
                    ...
                    if (uSumValueNumber == 0)
                    {
                        //"个数"百分比
                        g1.DrawString("0.00%",
                            new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush,
                            DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + DrawGraphProtocol.CylinderSpace) + DrawGraphProtocol.Module6LeftDistance,
                        ...
                        g1.DrawString("0.00%",
                            new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush,
                            DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + DrawGraphProtocol.CylinderSpace) + DrawGraphProtocol.Module6LeftDistance + DrawGraphProtocol.CylinderWidth,
                            PicExport.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module6CylinderDistance);
                    ...
                    {
                        //"个数"百分比
                        g1.DrawString(((double)dataInterface.IoStStatistics.nExitCount[i] / uSumValueNumber).ToString("0.00%"),
                            new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush,
                            DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + DrawGraphProtocol.CylinderSpace) + DrawGraphProtocol.Module6LeftDistance,
                            PicExport.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - (int)(CylinderHeight1 * ((double)dataInterface.IoStStatistics.nExitCount[i] / uMaxValueNumber)) - DrawGraphProtocol.Module6CylinderDistance);
                        //"重量"百分比
                        g1.DrawString(((double)dataInterface.IoStStatistics.nExitWeightCount[i] / uSumValueWeight).ToString("0.00%"),
                            new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush,
                            DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + DrawGraphProtocol.CylinderSpace) + DrawGraphProtocol.Module6LeftDistance + DrawGraphProtocol.CylinderWidth,
                            PicExport.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - (int)(CylinderHeight1 * ((double)dataInterface.IoStStatistics.nExitWeightCount[i] / uMaxValueWeight)) - DrawGraphProtocol.Module6CylinderDistance);
                ...
                else  //无滚动条时
                {
                    //"出口序号"字样
                    g1.DrawString((i + 1).ToString(), new Font(DrawGraphProtocol.Module4FontStyle, DrawGraphProtocol.Module4FontSize, FontStyle.Regular),
                    currentBrush, leftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + DrawGraphProtocol.CylinderSpace), PicExport.Height - DrawGraphProtocol.Module4BottomDistance);

                    if (dataInterface.IoStStatistics.nExitCount[i] == 0)
                    {
                        //"柱体"个数图形显示
                        g1.FillRectangle(BarBrush, leftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + DrawGraphProtocol.CylinderSpace),
                        PicExport.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.CylinderHeight4,
                        DrawGraphProtocol.CylinderWidth, DrawGraphProtocol.CylinderHeight4);
                        //"柱体"重量图形显示
                        g1.FillRectangle(BarBrushWeight, leftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + DrawGraphProtocol.CylinderSpace) + DrawGraphProtocol.CylinderWidth,
                        PicExport.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.CylinderHeight4,
                        DrawGraphProtocol.CylinderWidth, DrawGraphProtocol.CylinderHeight4);
                    }
                    else
                    {
                        ...
                        if ((int)(CylinderHeight1 * ((double)dataInterface.IoStStatistics.nExitCount[i] / uMaxValueNumber)) > DrawGraphProtocol.StandardCylinderHeight)
                        {
                            g1.TranslateTransform(leftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + DrawGraphProtocol.CylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance,
                            PicExport.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance);
                            g1.RotateTransform(-90f);
                            g1.DrawString(dataInterface.IoStStatistics.nExitCount[i].ToString(),
                                new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
                        ...
                        if ((int)(CylinderHeight1 * ((double)dataInterface.IoStStatistics.nExitWeightCount[i] / uMaxValueWeight)) > DrawGraphProtocol.StandardCylinderHeight)
                        {
                            g1.TranslateTransform(leftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + DrawGraphProtocol.CylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance + DrawGraphProtocol.CylinderWidth,
                            PicExport.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance);
                            g1.RotateTransform(-90f);
                            g1.DrawString(dataInterface.IoStStatistics.nExitWeightCount[i].ToString(),
                                new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
                    ...
                    if (uSumValueNumber == 0)
                    {
                        ...
                        g1.DrawString("0.00%",
                            new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush,
                            leftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + DrawGraphProtocol.CylinderSpace) + DrawGraphProtocol.Module6LeftDistance,
                            PicExport.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module6CylinderDistance);
                        //"重量"百分比
                        g1.DrawString("0.00%",
                            new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush,
                            leftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + DrawGraphProtocol.CylinderSpace) + DrawGraphProtocol.Module6LeftDistance + DrawGraphProtocol.CylinderWidth,
                            PicExport.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module6CylinderDistance);
        ...
        private void currentSelectTabpage2()
        {
            ...
            UInt64 totalFruitWeight = 0;  //每品质水果的总重量
            UInt64 maxFruitWeight = 0;    //所有品质中水果总重量最大值
            #endregion
            ...
            CurrentDisplayCylinderSpace = (LongestWeightOrSizeGradeName > (DrawGraphProtocol.CylinderWidth * 2 + DrawGraphProtocol.CylinderSpace)) ?
                (LongestWeightOrSizeGradeName - DrawGraphProtocol.CylinderWidth * 2) : DrawGraphProtocol.CylinderSpace;//如果(最长等级名称 > 圆柱宽+标准空格)，则空格宽度重新计算
            #endregion

            #region 界面设定
            if ((dataInterface.QualityGradeSum - 1) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) +
                DrawGraphProtocol.CylinderWidth * 2 + DrawGraphProtocol.Module2RightDistance < tabPage2.Width)  //无需使用滚动条
            {
                bHaveHscrollBar = false;
                hScrollBar2.Visible = false;
                PicQuality.Dock = DockStyle.Fill;
                CylinderHeight2 = DrawGraphProtocol.CylinderHeight2;
                leftRightSpace = (PicQuality.Width - (dataInterface.QualityGradeSum - 1) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) -
                    DrawGraphProtocol.CylinderWidth * 2 - DrawGraphProtocol.Module2RightDistance) / 2;
            }
            else  //需要使用滚动条
            {
                bHaveHscrollBar = true;
                PicQuality.Width = (dataInterface.QualityGradeSum - 1) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) +
                    DrawGraphProtocol.CylinderWidth * 2 + 2 * DrawGraphProtocol.LeftRightSpace + DrawGraphProtocol.Module2RightDistance;
            ...
            #region 数量/重量/百分比 品质统计信息
            //"数量/重量/百分比"字样
            //g.DrawString("数量/重量/百分比", new Font(DrawGraphProtocol.Module1FontStyle, DrawGraphProtocol.Module1FontSize, FontStyle.Regular),
            //    currentBrush, DrawGraphProtocol.Module1LocationX, DrawGraphProtocol.Module1LocationY);
            //"品质统计信息"字样
            ...
            #region 框 柱体1 柱体2 个数 重量
            //"颜色框"字样
            g2.DrawRectangle(new Pen(Color.Black), PicQuality.Width - DrawGraphProtocol.Module2RightDistance, PicQuality.Height / 2 - DrawGraphProtocol.Module2MiddleDistance,
                DrawGraphProtocol.Module2FrameWidth, DrawGraphProtocol.Module2FrameHeight);
            g2.FillRectangle(BarBrush, PicQuality.Width - DrawGraphProtocol.Module2RightDistance + DrawGraphProtocol.Module2SmallGraphHorizontalSpace,
                PicQuality.Height / 2 - DrawGraphProtocol.Module2MiddleDistance + DrawGraphProtocol.Module2SmallGraphVerticalSpace,
                DrawGraphProtocol.Module2SmallCylinderWidth, DrawGraphProtocol.Module2SmallCylinderHeight);
            g2.FillRectangle(BarBrushWeight, PicQuality.Width - DrawGraphProtocol.Module2RightDistance + DrawGraphProtocol.Module2SmallGraphHorizontalSpace,
                PicQuality.Height / 2 - DrawGraphProtocol.Module2MiddleDistance + DrawGraphProtocol.Module2SmallGraphVerticalSpace * 2 + DrawGraphProtocol.Module2SmallCylinderHeight,
                DrawGraphProtocol.Module2SmallCylinderWidth, DrawGraphProtocol.Module2SmallCylinderHeight);
            g2.DrawString(m_resourceManager.GetString("LblPieces.Text"), new Font(DrawGraphProtocol.Module2FontStyle, DrawGraphProtocol.Module2FontSize, FontStyle.Regular), currentBrush,
                PicQuality.Width - DrawGraphProtocol.Module2RightDistance + DrawGraphProtocol.Module2SmallGraphHorizontalSpace + DrawGraphProtocol.Module2SmallCylinderWidth + DrawGraphProtocol.Module2FontHorizontalSpace,
                PicQuality.Height / 2 - DrawGraphProtocol.Module2MiddleDistance + DrawGraphProtocol.Module2SmallGraphVerticalSpace + DrawGraphProtocol.Module2FontVerticalSpace);
            g2.DrawString(m_resourceManager.GetString("LblWeight.Text"), new Font(DrawGraphProtocol.Module2FontStyle, DrawGraphProtocol.Module2FontSize, FontStyle.Regular), currentBrush,
                PicQuality.Width - DrawGraphProtocol.Module2RightDistance + DrawGraphProtocol.Module2SmallGraphHorizontalSpace + DrawGraphProtocol.Module2SmallCylinderWidth + DrawGraphProtocol.Module2FontHorizontalSpace,
                PicQuality.Height / 2 - DrawGraphProtocol.Module2MiddleDistance + DrawGraphProtocol.Module2SmallGraphVerticalSpace + DrawGraphProtocol.Module2FontVerticalSpace +
                DrawGraphProtocol.Module2SmallGraphVerticalSpace + DrawGraphProtocol.Module2SmallCylinderHeight);
            #endregion

            #region 品质名称 （个数|重量）柱体 （个数|重量）个数 （个数|重量）百分比
            //找各品质中的个数最大值
            ...
            for (int i = 0; i < dataInterface.QualityGradeSum; i++)
            {
                if (bHaveHscrollBar)  //有滚动条时
                {
                    ...
                    g2.DrawString(Encoding.Default.GetString(dataInterface.IoStStGradeInfo.strQualityGradeName, i * ConstPreDefine.MAX_TEXT_LENGTH, ConstPreDefine.MAX_TEXT_LENGTH),
                        ...
                        currentBrush, DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace),
                    ...
                    for (int j = 0; j < dataInterface.WeightOrSizeGradeSum; j++)
                    {
                        totalFruitWeight += dataInterface.IoStStatistics.nWeightGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j];
                    }

                    if (totalFruitNumber == 0)
                    {
                        //"柱体"个数图形显示
                        g2.FillRectangle(BarBrush, DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace),
                        ...
                        DrawGraphProtocol.CylinderWidth, DrawGraphProtocol.CylinderHeight4);
                        //"柱体"重量图形显示
                        g2.FillRectangle(BarBrushWeight, DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.CylinderWidth,
                        PicQuality.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.CylinderHeight4,
                        DrawGraphProtocol.CylinderWidth, DrawGraphProtocol.CylinderHeight4);
                    }
                    else
                    {
                        ...
                        //"柱体"重量图形显示
                        g2.FillRectangle(BarBrushWeight, DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.CylinderWidth,
                        PicQuality.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - (int)(CylinderHeight2 * ((double)totalFruitWeight / maxFruitWeight)),
                        DrawGraphProtocol.CylinderWidth, (int)(CylinderHeight2 * ((double)totalFruitWeight / maxFruitWeight)));
                        
                        //显示"个数"值
                        if ((int)(CylinderHeight2 * ((double)totalFruitNumber / maxFruitNumber)) > DrawGraphProtocol.StandardCylinderHeight)
                        {
                            g2.TranslateTransform(DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance,
                        ...
                        //显示"重量"值
                        if ((int)(CylinderHeight2 * ((double)totalFruitWeight / maxFruitWeight)) > DrawGraphProtocol.StandardCylinderHeight)
                        {
                            g2.TranslateTransform(DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance + DrawGraphProtocol.CylinderWidth,
                            PicQuality.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance);
                            g2.RotateTransform(-90f);
                            g2.DrawString(totalFruitWeight.ToString(),
                                new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
                            g2.ResetTransform();
                        }
                        else
                    ...
                    if (dataInterface.IoStStatistics.nTotalCount == 0)
                    {
                        ...
                        g2.DrawString("0.00%",
                            new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush,
                            DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module6LeftDistance,
                        ...
                        g2.DrawString("0.00%",
                            new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush,
                            DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module6LeftDistance + DrawGraphProtocol.CylinderWidth,
                            PicQuality.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module6CylinderDistance);
                    }
                    else
                    {
                        ...
                        //"重量"百分比
                        g2.DrawString(((double)totalFruitWeight / dataInterface.IoStStatistics.nWeightCount).ToString("0.00%"),
                            new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush,
                            DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module6LeftDistance + DrawGraphProtocol.CylinderWidth,
                            PicQuality.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - (int)(CylinderHeight2 * ((double)totalFruitWeight / maxFruitWeight)) - DrawGraphProtocol.Module6CylinderDistance);
                    }
                    
                    totalFruitNumber = 0;  //清零
                    totalFruitWeight = 0;  //清零
                ...
                else  //无滚动条时
                {
                    ...
                    g2.DrawString(Encoding.Default.GetString(dataInterface.IoStStGradeInfo.strQualityGradeName, i * ConstPreDefine.MAX_TEXT_LENGTH, ConstPreDefine.MAX_TEXT_LENGTH),
                        new Font(DrawGraphProtocol.Module4FontStyle, DrawGraphProtocol.Module4FontSize, FontStyle.Regular),
                        currentBrush, leftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace),
                        PicQuality.Height - DrawGraphProtocol.Module4BottomDistance);
                    ...
                    {
                        //"柱体"个数图形显示
                        g2.FillRectangle(BarBrush, leftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace),
                        PicQuality.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.CylinderHeight4,
                        DrawGraphProtocol.CylinderWidth, DrawGraphProtocol.CylinderHeight4);
                        //"柱体"重量图形显示
                        g2.FillRectangle(BarBrushWeight, leftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace )+ DrawGraphProtocol.CylinderWidth,
                        PicQuality.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.CylinderHeight4,
                        DrawGraphProtocol.CylinderWidth, DrawGraphProtocol.CylinderHeight4);
                    }
                    else
                    {
                        ...
                        if ((int)(CylinderHeight2 * ((double)totalFruitNumber / maxFruitNumber)) > DrawGraphProtocol.StandardCylinderHeight)
                        {
                            g2.TranslateTransform(leftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance,
                            PicQuality.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance);
                            g2.RotateTransform(-90f);
                            g2.DrawString(totalFruitNumber.ToString(),
                                new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
                        ...
                        if ((int)(CylinderHeight2 * ((double)totalFruitWeight / maxFruitWeight)) > DrawGraphProtocol.StandardCylinderHeight)
                        {
                            g2.TranslateTransform(leftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance + DrawGraphProtocol.CylinderWidth,
                            PicQuality.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance);
                            g2.RotateTransform(-90f);
                            g2.DrawString(totalFruitWeight.ToString(),
                                new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
                    ...
                    if (dataInterface.IoStStatistics.nTotalCount == 0)
                    {
                        ...
                        g2.DrawString("0.00%",
                            new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush,
                            leftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module6LeftDistance,
                            PicQuality.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module6CylinderDistance);
                        //"重量"百分比
                        g2.DrawString("0.00%",
                            new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush,
                            leftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module6LeftDistance + DrawGraphProtocol.CylinderWidth,
                            PicQuality.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module6CylinderDistance);               
                    }
                    else
                    {
        ...
        private void currentSelectTabpage3()
        {
            ...
            UInt64[] colorFruitWeight = new UInt64[ConstPreDefine.MAX_COLOR_GRADE_NUM];
            ...
            for (int i = 0; i < dataInterface.QualityGradeSum; i++)
            {
                for (int j = 0; j < dataInterface.WeightOrSizeGradeSum; j++)
                {
                    UInt64 tempNum = dataInterface.IoStStatistics.nGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j];
                    UInt64 tempWeight = dataInterface.IoStStatistics.nWeightGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j];
                    switch (Convert.ToInt32(dataInterface.IoStStGradeInfo.grades[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j].nColorGrade))
                    {
                        case 0:
                            ...
                            colorFruitWeight[0] += tempWeight;
                            break;
                        case 1:
                            colorFruitNumber[1] += tempNum;
                            colorFruitWeight[1] += tempWeight;
                            break;
                        case 2:
                            colorFruitNumber[2] += tempNum;
                            colorFruitWeight[2] += tempWeight;
                            break;
                        case 3:
                            colorFruitNumber[3] += tempNum;
                            colorFruitWeight[3] += tempWeight;
                            break;
                        case 4:
                            colorFruitNumber[4] += tempNum;
                            colorFruitWeight[4] += tempWeight;
                            break;
                        case 5:
                            colorFruitNumber[5] += tempNum;
                            colorFruitWeight[5] += tempWeight;
                            break;
                        case 6:
                            colorFruitNumber[6] += tempNum;
                            colorFruitWeight[6] += tempWeight;
                            break;
                        case 7:
                            colorFruitNumber[7] += tempNum;
                            colorFruitWeight[7] += tempWeight;
                            break;
                        case 8:
                            colorFruitNumber[8] += tempNum;
                            colorFruitWeight[8] += tempWeight;
                            break;
                        case 9:
                            colorFruitNumber[9] += tempNum;
                            colorFruitWeight[9] += tempWeight;
                            break;
                        case 10:
                            colorFruitNumber[10] += tempNum;
                            colorFruitWeight[10] += tempWeight;
                            break;
                        case 11:
                            colorFruitNumber[11] += tempNum;
                            colorFruitWeight[11] += tempWeight;
                            break;
                        case 12:
                            colorFruitNumber[12] += tempNum;
                            colorFruitWeight[12] += tempWeight;
                            break;
                        case 13:
                            colorFruitNumber[13] += tempNum;
                            colorFruitWeight[13] += tempWeight;
                            break;
                        case 14:
                            colorFruitNumber[14] += tempNum;
                            colorFruitWeight[14] += tempWeight;
                            break;
                        case 15:
                            colorFruitNumber[15] += tempNum;
                            colorFruitWeight[15] += tempWeight;
                            break;
                        default:
                            break;
                    }
            ...
            #endregion
            UInt64 uMaxValue1 = FunctionInterface.GetMaxValue(colorFruitNumber);
            UInt64 uSumValue1 = FunctionInterface.GetSumValue(colorFruitNumber);
            UInt64 uMaxValue2 = FunctionInterface.GetMaxValue(colorFruitWeight);
            UInt64 uSumValue2 = FunctionInterface.GetSumValue(colorFruitWeight);
            #endregion
            ...
            #region 界面设定
            if ((colorGrade.Length - 1) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) +
                DrawGraphProtocol.CylinderWidth * 2 + DrawGraphProtocol.Module2RightDistance < tabPage3.Width)  //无需使用滚动条
            {
                bHaveHscrollBar = false;
                hScrollBar3.Visible = false;
                PicColor.Dock = DockStyle.Fill;
                CylinderHeight3 = DrawGraphProtocol.CylinderHeight2;
                leftRightSpace = (PicColor.Width - (colorGrade.Length - 1) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) -
                    DrawGraphProtocol.CylinderWidth * 2 - DrawGraphProtocol.Module2RightDistance) / 2;
            }
            else  //需要使用滚动条
            {
                bHaveHscrollBar = true;
                PicColor.Width = (colorGrade.Length - 1) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) +
                    DrawGraphProtocol.CylinderWidth * 2 + 2 * DrawGraphProtocol.LeftRightSpace + DrawGraphProtocol.Module2RightDistance;
            ...
            #region 框 柱体1 柱体2 个数 重量
            //"颜色框"字样
            g3.DrawRectangle(new Pen(Color.Black), PicColor.Width - DrawGraphProtocol.Module2RightDistance, PicColor.Height / 2 - DrawGraphProtocol.Module2MiddleDistance,
                DrawGraphProtocol.Module2FrameWidth, DrawGraphProtocol.Module2FrameHeight);
            g3.FillRectangle(BarBrush, PicColor.Width - DrawGraphProtocol.Module2RightDistance + DrawGraphProtocol.Module2SmallGraphHorizontalSpace,
                PicColor.Height / 2 - DrawGraphProtocol.Module2MiddleDistance + DrawGraphProtocol.Module2SmallGraphVerticalSpace,
                DrawGraphProtocol.Module2SmallCylinderWidth, DrawGraphProtocol.Module2SmallCylinderHeight);
            g3.FillRectangle(BarBrushWeight, PicColor.Width - DrawGraphProtocol.Module2RightDistance + DrawGraphProtocol.Module2SmallGraphHorizontalSpace,
                PicColor.Height / 2 - DrawGraphProtocol.Module2MiddleDistance + DrawGraphProtocol.Module2SmallGraphVerticalSpace * 2 + DrawGraphProtocol.Module2SmallCylinderHeight,
                DrawGraphProtocol.Module2SmallCylinderWidth, DrawGraphProtocol.Module2SmallCylinderHeight);
            g3.DrawString(m_resourceManager.GetString("LblPieces.Text"), new Font(DrawGraphProtocol.Module2FontStyle, DrawGraphProtocol.Module2FontSize, FontStyle.Regular), currentBrush,
                PicColor.Width - DrawGraphProtocol.Module2RightDistance + DrawGraphProtocol.Module2SmallGraphHorizontalSpace + DrawGraphProtocol.Module2SmallCylinderWidth + DrawGraphProtocol.Module2FontHorizontalSpace,
                PicColor.Height / 2 - DrawGraphProtocol.Module2MiddleDistance + DrawGraphProtocol.Module2SmallGraphVerticalSpace + DrawGraphProtocol.Module2FontVerticalSpace);
            g3.DrawString(m_resourceManager.GetString("LblWeight.Text"), new Font(DrawGraphProtocol.Module2FontStyle, DrawGraphProtocol.Module2FontSize, FontStyle.Regular), currentBrush,
                PicColor.Width - DrawGraphProtocol.Module2RightDistance + DrawGraphProtocol.Module2SmallGraphHorizontalSpace + DrawGraphProtocol.Module2SmallCylinderWidth + DrawGraphProtocol.Module2FontHorizontalSpace,
                PicColor.Height / 2 - DrawGraphProtocol.Module2MiddleDistance + DrawGraphProtocol.Module2SmallGraphVerticalSpace + DrawGraphProtocol.Module2FontVerticalSpace +
                DrawGraphProtocol.Module2SmallGraphVerticalSpace + DrawGraphProtocol.Module2SmallCylinderHeight);
            #endregion

            #region 颜色名称 （个数|重量）柱体 （个数|重量）个数 （个数|重量）百分比
            for (int i = 0; i < colorGrade.Length; i++)
            {
                if (bHaveHscrollBar)  //有滚动条时
                {
                    ...
                    {
                        //"柱体"图形显示
                        g3.FillRectangle(BarBrush, DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace),
                        ...
                        DrawGraphProtocol.CylinderWidth, DrawGraphProtocol.CylinderHeight4);
                        //"柱体"重量图形显示
                        g3.FillRectangle(BarBrushWeight, DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.CylinderWidth,
                        PicColor.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.CylinderHeight4,
                        DrawGraphProtocol.CylinderWidth, DrawGraphProtocol.CylinderHeight4);
                    }
                    else
                    {
                        //"柱体"图形显示  个数
                        g3.FillRectangle(BarBrush, DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace),
                        PicColor.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - (int)(CylinderHeight3 * ((double)colorFruitNumber[i] / uMaxValue1)),
                        DrawGraphProtocol.CylinderWidth, (int)(CylinderHeight3 * ((double)colorFruitNumber[i] / uMaxValue1)));
                        //"柱体"重量图形显示
                        g3.FillRectangle(BarBrushWeight, DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.CylinderWidth,
                        PicColor.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - (int)(CylinderHeight3 * ((double)colorFruitWeight[i] / uMaxValue2)),
                        DrawGraphProtocol.CylinderWidth, (int)(CylinderHeight3 * ((double)colorFruitWeight[i] / uMaxValue2)));
                        
                        //显示"个数"值
                        if ((int)(CylinderHeight3 * ((double)colorFruitNumber[i] / uMaxValue1)) > DrawGraphProtocol.StandardCylinderHeight)
                        {
                            g3.TranslateTransform(DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance,
                        ...
                        else
                        {
                            g3.TranslateTransform(DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance,
                            PicColor.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance-
                            (int)(CylinderHeight3 * ((double)colorFruitNumber[i] / uMaxValue1)));
                            g3.RotateTransform(-90f);
                            g3.DrawString(colorFruitNumber[i].ToString(),
                                new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
                            g3.ResetTransform();
                        ...
                        //显示"重量"值
                        if ((int)(CylinderHeight3 * ((double)colorFruitWeight[i] / uMaxValue2)) > DrawGraphProtocol.StandardCylinderHeight)
                        {
                            g3.TranslateTransform(DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance + DrawGraphProtocol.CylinderWidth,
                            PicColor.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance);
                            g3.RotateTransform(-90f);
                            g3.DrawString(colorFruitWeight[i].ToString(),
                                new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
                            g3.ResetTransform();
                        }
                        else
                        {
                            g3.TranslateTransform(DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance + DrawGraphProtocol.CylinderWidth,
                            PicColor.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance-
                            (int)(CylinderHeight3 * ((double)colorFruitWeight[i] / uMaxValue2)));
                            g3.RotateTransform(-90f);
                            g3.DrawString(colorFruitWeight[i].ToString(),
                                new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
                            g3.ResetTransform();
                    ...
                    {
                        //"个数"百分比
                        g3.DrawString(((double)colorFruitNumber[i] / uSumValue1).ToString("0.00%"),
                            new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush,
                            DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module6LeftDistance,
                            PicColor.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - (int)(CylinderHeight3 * ((double)colorFruitNumber[i] / uMaxValue1)) - DrawGraphProtocol.Module6CylinderDistance);
                        //"重量"百分比
                        g3.DrawString(((double)colorFruitWeight[i] / uSumValue2).ToString("0.00%"),
                            new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush,
                            DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module6LeftDistance + DrawGraphProtocol.CylinderWidth,
                            PicColor.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - (int)(CylinderHeight3 * ((double)colorFruitWeight[i] / uMaxValue2)) - DrawGraphProtocol.Module6CylinderDistance);
                    }
                ...
                else  //无滚动条时
                {
                    ...
                    {
                        //"柱体"图形显示
                        g3.FillRectangle(BarBrush, leftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace),
                        PicColor.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.CylinderHeight4,
                        DrawGraphProtocol.CylinderWidth, DrawGraphProtocol.CylinderHeight4);
                        //"柱体"重量图形显示
                        g3.FillRectangle(BarBrushWeight, leftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.CylinderWidth,
                        PicColor.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.CylinderHeight4,
                        DrawGraphProtocol.CylinderWidth, DrawGraphProtocol.CylinderHeight4);
                    }
                    else
                    {
                        ...
                        if ((int)(CylinderHeight3 * ((double)colorFruitNumber[i] / uMaxValue1)) > DrawGraphProtocol.StandardCylinderHeight)
                        {
                            g3.TranslateTransform(leftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance,
                            PicColor.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance);
                            g3.RotateTransform(-90f);
                            g3.DrawString(colorFruitNumber[i].ToString(),
                                new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
                        ...
                        if ((int)(CylinderHeight3 * ((double)colorFruitWeight[i] / uMaxValue2)) > DrawGraphProtocol.StandardCylinderHeight)
                        {
                            g3.TranslateTransform(leftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance + DrawGraphProtocol.CylinderWidth,
                            PicColor.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance);
                            g3.RotateTransform(-90f);
                            g3.DrawString(colorFruitWeight[i].ToString(),
                                new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
        ...
        private void currentSelectTabpage4()
        {
            ...
            UInt64[] shapeFruitWeight = new UInt64[ConstPreDefine.MAX_SHAPE_GRADE_NUM];
            ...
            #endregion
            UInt64 uMaxValue1 = FunctionInterface.GetMaxValue(shapeFruitNumber);
            UInt64 uSumValue1 = FunctionInterface.GetSumValue(shapeFruitNumber);
            UInt64 uMaxValue2 = FunctionInterface.GetMaxValue(shapeFruitWeight);
            UInt64 uSumValue2 = FunctionInterface.GetSumValue(shapeFruitWeight);
            #endregion
            ...
            #region 界面设定
            if ((shapeGrade.Length - 1) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) +
                DrawGraphProtocol.CylinderWidth * 2 + DrawGraphProtocol.Module2RightDistance < tabPage4.Width)  //无需使用滚动条
            {
                bHaveHscrollBar = false;
                hScrollBar4.Visible = false;
                PicShape.Dock = DockStyle.Fill;
                CylinderHeight4 = DrawGraphProtocol.CylinderHeight2;
                leftRightSpace = (PicShape.Width - (shapeGrade.Length - 1) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) -
                    DrawGraphProtocol.CylinderWidth * 2 - DrawGraphProtocol.Module2RightDistance) / 2;
            }
            else  //需要使用滚动条
            {
                bHaveHscrollBar = true;
                PicShape.Width = (shapeGrade.Length - 1) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) +
                    DrawGraphProtocol.CylinderWidth * 2 + 2 * DrawGraphProtocol.LeftRightSpace + DrawGraphProtocol.Module2RightDistance;
            ...
            #region 框 柱体1 柱体2 个数 重量
            //"颜色框"字样
            g4.DrawRectangle(new Pen(Color.Black), PicShape.Width - DrawGraphProtocol.Module2RightDistance, PicShape.Height / 2 - DrawGraphProtocol.Module2MiddleDistance,
                DrawGraphProtocol.Module2FrameWidth, DrawGraphProtocol.Module2FrameHeight);
            g4.FillRectangle(BarBrush, PicShape.Width - DrawGraphProtocol.Module2RightDistance + DrawGraphProtocol.Module2SmallGraphHorizontalSpace,
                PicShape.Height / 2 - DrawGraphProtocol.Module2MiddleDistance + DrawGraphProtocol.Module2SmallGraphVerticalSpace,
                DrawGraphProtocol.Module2SmallCylinderWidth, DrawGraphProtocol.Module2SmallCylinderHeight);
            g4.FillRectangle(BarBrushWeight, PicShape.Width - DrawGraphProtocol.Module2RightDistance + DrawGraphProtocol.Module2SmallGraphHorizontalSpace,
                PicShape.Height / 2 - DrawGraphProtocol.Module2MiddleDistance + DrawGraphProtocol.Module2SmallGraphVerticalSpace * 2 + DrawGraphProtocol.Module2SmallCylinderHeight,
                DrawGraphProtocol.Module2SmallCylinderWidth, DrawGraphProtocol.Module2SmallCylinderHeight);
            g4.DrawString(m_resourceManager.GetString("LblPieces.Text"), new Font(DrawGraphProtocol.Module2FontStyle, DrawGraphProtocol.Module2FontSize, FontStyle.Regular), currentBrush,
                PicShape.Width - DrawGraphProtocol.Module2RightDistance + DrawGraphProtocol.Module2SmallGraphHorizontalSpace + DrawGraphProtocol.Module2SmallCylinderWidth + DrawGraphProtocol.Module2FontHorizontalSpace,
                PicShape.Height / 2 - DrawGraphProtocol.Module2MiddleDistance + DrawGraphProtocol.Module2SmallGraphVerticalSpace + DrawGraphProtocol.Module2FontVerticalSpace);
            g4.DrawString(m_resourceManager.GetString("LblWeight.Text"), new Font(DrawGraphProtocol.Module2FontStyle, DrawGraphProtocol.Module2FontSize, FontStyle.Regular), currentBrush,
                PicShape.Width - DrawGraphProtocol.Module2RightDistance + DrawGraphProtocol.Module2SmallGraphHorizontalSpace + DrawGraphProtocol.Module2SmallCylinderWidth + DrawGraphProtocol.Module2FontHorizontalSpace,
                PicShape.Height / 2 - DrawGraphProtocol.Module2MiddleDistance + DrawGraphProtocol.Module2SmallGraphVerticalSpace + DrawGraphProtocol.Module2FontVerticalSpace +
                DrawGraphProtocol.Module2SmallGraphVerticalSpace + DrawGraphProtocol.Module2SmallCylinderHeight);
            #endregion

            #region 形状名称 （个数|重量）柱体 （个数|重量）个数 （个数|重量）百分比
            for (int i = 0; i < shapeGrade.Length; i++)
            {
                if (bHaveHscrollBar)  //有滚动条时
                {
                    ...
                    {
                        //"柱体"图形显示
                        g4.FillRectangle(BarBrush, DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace),
                        ...
                        DrawGraphProtocol.CylinderWidth, DrawGraphProtocol.CylinderHeight4);
                        //"柱体"重量图形显示
                        g4.FillRectangle(BarBrushWeight, DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.CylinderWidth,
                        PicShape.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.CylinderHeight4,
                        DrawGraphProtocol.CylinderWidth, DrawGraphProtocol.CylinderHeight4);
                    }
                    else
                    {
                        //"柱体"图形显示  个数
                        g4.FillRectangle(BarBrush, DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace),
                        PicShape.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - (int)(CylinderHeight4 * ((double)shapeFruitNumber[i] / uMaxValue1)),
                        DrawGraphProtocol.CylinderWidth, (int)(CylinderHeight4 * ((double)shapeFruitNumber[i] / uMaxValue1)));
                        //"柱体"重量图形显示
                        g4.FillRectangle(BarBrushWeight, DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.CylinderWidth,
                        PicShape.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - (int)(CylinderHeight4 * ((double)shapeFruitWeight[i] / uMaxValue2)),
                        DrawGraphProtocol.CylinderWidth, (int)(CylinderHeight4 * ((double)shapeFruitWeight[i] / uMaxValue2)));
                        
                        //显示"个数"值
                        if ((int)(CylinderHeight4 * ((double)shapeFruitNumber[i] / uMaxValue1)) > DrawGraphProtocol.StandardCylinderHeight)
                        {
                            g4.TranslateTransform(DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance,
                        ...
                        else
                        {
                            g4.TranslateTransform(DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance,
                            PicShape.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance-
                            (int)(CylinderHeight4 * ((double)shapeFruitNumber[i] / uMaxValue1)));
                            g4.RotateTransform(-90f);
                            g4.DrawString(shapeFruitNumber[i].ToString(),
                                new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
                            g4.ResetTransform();
                        ...
                        //显示"重量"值
                        if ((int)(CylinderHeight4 * ((double)shapeFruitWeight[i] / uMaxValue2)) > DrawGraphProtocol.StandardCylinderHeight)
                        {
                            g4.TranslateTransform(DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance + DrawGraphProtocol.CylinderWidth,
                            PicShape.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance);
                            g4.RotateTransform(-90f);
                            g4.DrawString(shapeFruitWeight[i].ToString(),
                                new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
                            g4.ResetTransform();
                        }
                        else
                        {
                            g4.TranslateTransform(DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance + DrawGraphProtocol.CylinderWidth,
                            PicShape.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance-
                            (int)(CylinderHeight4 * ((double)shapeFruitWeight[i] / uMaxValue2)));
                            g4.RotateTransform(-90f);
                            g4.DrawString(shapeFruitWeight[i].ToString(),
                                new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
                            g4.ResetTransform();
                    ...
                    {
                        //"个数"百分比
                        g4.DrawString(((double)shapeFruitNumber[i] / uSumValue1).ToString("0.00%"),
                            new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush,
                            DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module6LeftDistance,
                            PicShape.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - (int)(CylinderHeight4 * ((double)shapeFruitNumber[i] / uMaxValue1)) - DrawGraphProtocol.Module6CylinderDistance);
                        //"重量"百分比
                        g4.DrawString(((double)shapeFruitWeight[i] / uSumValue2).ToString("0.00%"),
                            new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush,
                            DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module6LeftDistance + DrawGraphProtocol.CylinderWidth,
                            PicShape.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - (int)(CylinderHeight4 * ((double)shapeFruitWeight[i] / uMaxValue2)) - DrawGraphProtocol.Module6CylinderDistance);
                    }
                ...
                else  //无滚动条时
                {
                    ...
                    {
                        //"柱体"图形显示
                        g4.FillRectangle(BarBrush, leftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace),
                        PicShape.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.CylinderHeight4,
                        DrawGraphProtocol.CylinderWidth, DrawGraphProtocol.CylinderHeight4);
                        //"柱体"重量图形显示
                        g4.FillRectangle(BarBrushWeight, leftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.CylinderWidth,
                        PicShape.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.CylinderHeight4,
                        DrawGraphProtocol.CylinderWidth, DrawGraphProtocol.CylinderHeight4);
                    }
                    else
                    {
                        ...
                        if ((int)(CylinderHeight4 * ((double)shapeFruitNumber[i] / uMaxValue1)) > DrawGraphProtocol.StandardCylinderHeight)
                        {
                            g4.TranslateTransform(leftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance,
                            PicShape.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance);
                            g4.RotateTransform(-90f);
                            g4.DrawString(shapeFruitNumber[i].ToString(),
                                new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
                        ...
                        if ((int)(CylinderHeight4 * ((double)shapeFruitWeight[i] / uMaxValue2)) > DrawGraphProtocol.StandardCylinderHeight)
                        {
                            g4.TranslateTransform(leftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance + DrawGraphProtocol.CylinderWidth,
                            PicShape.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance);
                            g4.RotateTransform(-90f);
                            g4.DrawString(shapeFruitWeight[i].ToString(),
                                new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
        ...
        {
            currentSelectIndex = CboWeightType.SelectedIndex;
            ReflashTabPage5();
        }
        ...
        private void ReflashTabPage5()
        {
            ...
            #region 界面设定
            if ((dataInterface.WeightOrSizeGradeSum - 1) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) +
                DrawGraphProtocol.CylinderWidth * 2 < tabPage5.Width)  //无需使用滚动条
            {
                bHaveHscrollBar = false;
                //hScrollBar5.Visible = false;
                //PicWeight.Dock = DockStyle.Fill;
                hScrollBar5.Maximum = PicWeight.Width - tabPage5.Width;
                CylinderHeight5 = DrawGraphProtocol.CylinderHeight3;
                leftRightSpace = (PicWeight.Width - (dataInterface.WeightOrSizeGradeSum - 1) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) -
                    DrawGraphProtocol.CylinderWidth * 2) / 2;
            }
            else  //需要使用滚动条
            {
                bHaveHscrollBar = true;
                CylinderHeight5 = DrawGraphProtocol.CylinderHeight3;
                PicWeight.Width = (dataInterface.WeightOrSizeGradeSum - 1) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) +
                    DrawGraphProtocol.CylinderWidth * 2 + 2 * DrawGraphProtocol.LeftRightSpace;
                PicBox.Width = (dataInterface.WeightOrSizeGradeSum - 1) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) +
                    DrawGraphProtocol.CylinderWidth * 2 + 2 * DrawGraphProtocol.LeftRightSpace;
                hScrollBar5.Maximum = PicWeight.Width - tabPage5.Width;
            }
            #endregion
            ...
            #region 绘制PicWeight
            //Bitmap bitM = new Bitmap(PicWeight.Width, PicWeight.Height);
            //Graphics g = Graphics.FromImage(bitM);
            if(bitM51 == null) //Modify by ChengSk - 20180815
            {
                bitM51 = new Bitmap(PicWeight.Width, PicWeight.Height);
            ...
            #region 数量/百分比 重量统计信息
            //"数量百分比"字样
            //g.DrawString("数量/百分比", new Font(DrawGraphProtocol.Module1FontStyle, DrawGraphProtocol.Module1FontSize, FontStyle.Regular),
            //    currentBrush, DrawGraphProtocol.Module1LocationX, DrawGraphProtocol.Module1LocationY);
            //"出口统计信息"字样
            g51.DrawString(m_resourceManager.GetString("LblQualityWeightLevel.Text"), new Font(DrawGraphProtocol.Module3FontStyle, DrawGraphProtocol.Module3FontSize, FontStyle.Bold),
                currentBrush, PicWeight.Width / 2 - 100, PicWeight.Height - DrawGraphProtocol.Module3BottomDistance);
            #endregion

            //#region 框 柱体1 柱体2 个数 重量
            ////"颜色框"字样
            //g.DrawRectangle(new Pen(Color.Black), PicWeight.Width - DrawGraphProtocol.Module2RightDistance, PicWeight.Height / 2 - DrawGraphProtocol.Module2MiddleDistance,
            //    DrawGraphProtocol.Module2FrameWidth, DrawGraphProtocol.Module2FrameHeight);
            //g.FillRectangle(BarBrush, PicWeight.Width - DrawGraphProtocol.Module2RightDistance + DrawGraphProtocol.Module2SmallGraphHorizontalSpace,
            //    PicWeight.Height / 2 - DrawGraphProtocol.Module2MiddleDistance + DrawGraphProtocol.Module2SmallGraphVerticalSpace,
            //    DrawGraphProtocol.Module2SmallCylinderWidth, DrawGraphProtocol.Module2SmallCylinderHeight);
            //g.FillRectangle(BarBrushWeight, PicWeight.Width - DrawGraphProtocol.Module2RightDistance + DrawGraphProtocol.Module2SmallGraphHorizontalSpace,
            //    PicWeight.Height / 2 - DrawGraphProtocol.Module2MiddleDistance + DrawGraphProtocol.Module2SmallGraphVerticalSpace * 2 + DrawGraphProtocol.Module2SmallCylinderHeight,
            //    DrawGraphProtocol.Module2SmallCylinderWidth, DrawGraphProtocol.Module2SmallCylinderHeight);
            //g.DrawString(m_resourceManager.GetString("LblPieces.Text"), new Font(DrawGraphProtocol.Module2FontStyle, DrawGraphProtocol.Module2FontSize, FontStyle.Regular), currentBrush,
            //    PicWeight.Width - DrawGraphProtocol.Module2RightDistance + DrawGraphProtocol.Module2SmallGraphHorizontalSpace + DrawGraphProtocol.Module2SmallCylinderWidth + DrawGraphProtocol.Module2FontHorizontalSpace,
            //    PicWeight.Height / 2 - DrawGraphProtocol.Module2MiddleDistance + DrawGraphProtocol.Module2SmallGraphVerticalSpace + DrawGraphProtocol.Module2FontVerticalSpace);
            //g.DrawString(m_resourceManager.GetString("LblWeight.Text"), new Font(DrawGraphProtocol.Module2FontStyle, DrawGraphProtocol.Module2FontSize, FontStyle.Regular), currentBrush,
            //    PicWeight.Width - DrawGraphProtocol.Module2RightDistance + DrawGraphProtocol.Module2SmallGraphHorizontalSpace + DrawGraphProtocol.Module2SmallCylinderWidth + DrawGraphProtocol.Module2FontHorizontalSpace,
            //    PicWeight.Height / 2 - DrawGraphProtocol.Module2MiddleDistance + DrawGraphProtocol.Module2SmallGraphVerticalSpace + DrawGraphProtocol.Module2FontVerticalSpace +
            //    DrawGraphProtocol.Module2SmallGraphVerticalSpace + DrawGraphProtocol.Module2SmallCylinderHeight);
            //#endregion

            #region 混合等级名称 （个数|重量）柱体 （个数|重量）个数 （个数|重量）百分比
            //"重量名称"字样  "柱体"图形显示  个数  百分比
            UInt64 uMaxValue1 = 0;    //"个数"最大值
            UInt64 uSumValue1 = 0;    //"个数"总值
            UInt64 uMaxValue2 = 0;    //"重量"最大值
            UInt64 uSumValue2 = 0;    //"重量"总值
            string strSizeName;       //"重量等级"名称
            string strQualityName;    //"品质等级"名称
            string strMixName;        //总名称：重量名称.品质名称
            uMaxValue1 = FunctionInterface.GetMaxValue(dataInterface.IoStStatistics.nGradeCount);
            uSumValue1 = FunctionInterface.GetSumValue(dataInterface.IoStStatistics.nGradeCount);
            uMaxValue2 = FunctionInterface.GetMaxValue(dataInterface.IoStStatistics.nWeightGradeCount);
            uSumValue2 = FunctionInterface.GetSumValue(dataInterface.IoStStatistics.nWeightGradeCount);

            for (int k = 0; k < dataInterface.WeightOrSizeGradeSum; k++)
            {
                if (bHaveHscrollBar)  //有滚动条时
                {
                    //"特征名称"字样
                    strSizeName = Encoding.Default.GetString(dataInterface.IoStStGradeInfo.strSizeGradeName, k * ConstPreDefine.MAX_TEXT_LENGTH, ConstPreDefine.MAX_TEXT_LENGTH);
                    strSizeName = strSizeName.Substring(0, strSizeName.IndexOf("\0"));
                    g51.DrawString(strSizeName,
                    new Font(DrawGraphProtocol.Module4FontStyle, DrawGraphProtocol.Module4FontSize, FontStyle.Regular),
                    currentBrush, DrawGraphProtocol.LeftRightSpace + k * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace),
                    PicWeight.Height - DrawGraphProtocol.Module4BottomDistance);

                    if (dataInterface.IoStStatistics.nGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + k] == 0)
                    {
                        //"柱体"图形显示
                        g51.FillRectangle(BarBrush, DrawGraphProtocol.LeftRightSpace + k * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace),
                        PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.CylinderHeight4,
                        DrawGraphProtocol.CylinderWidth, DrawGraphProtocol.CylinderHeight4);
                        //"柱体"重量图形显示
                        g51.FillRectangle(BarBrushWeight, DrawGraphProtocol.LeftRightSpace + k * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.CylinderWidth,
                        PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.CylinderHeight4,
                        DrawGraphProtocol.CylinderWidth, DrawGraphProtocol.CylinderHeight4);
                    }
                    else
                    {
                        //"柱体"图形显示  个数
                        g51.FillRectangle(BarBrush, DrawGraphProtocol.LeftRightSpace + k * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace),
                        PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - (int)(CylinderHeight5 * ((double)dataInterface.IoStStatistics.nGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + k] / uMaxValue1)),
                        DrawGraphProtocol.CylinderWidth, (int)(CylinderHeight5 * ((double)dataInterface.IoStStatistics.nGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + k] / uMaxValue1)));
                        //"柱体"重量图形显示
                        g51.FillRectangle(BarBrushWeight, DrawGraphProtocol.LeftRightSpace + k * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.CylinderWidth,
                        PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - (int)(CylinderHeight5 * ((double)dataInterface.IoStStatistics.nWeightGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + k] / uMaxValue2)),
                        DrawGraphProtocol.CylinderWidth, (int)(CylinderHeight5 * ((double)dataInterface.IoStStatistics.nWeightGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + k] / uMaxValue2)));

                        //显示"个数"值
                        if ((int)(CylinderHeight5 * ((double)dataInterface.IoStStatistics.nGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + k] / uMaxValue1)) > DrawGraphProtocol.StandardCylinderHeight)
                        {
                            g51.TranslateTransform(DrawGraphProtocol.LeftRightSpace + k * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance,
                            PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance);
                            g51.RotateTransform(-90f);
                            g51.DrawString(dataInterface.IoStStatistics.nGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + k].ToString(),
                                new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
                            g51.ResetTransform();
                        }
                        else
                        {
                            g51.TranslateTransform(DrawGraphProtocol.LeftRightSpace + k * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance,
                            PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance -
                            (int)(CylinderHeight5 * ((double)dataInterface.IoStStatistics.nGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + k] / uMaxValue1)));
                            g51.RotateTransform(-90f);
                            g51.DrawString(dataInterface.IoStStatistics.nGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + k].ToString(),
                                new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
                            g51.ResetTransform();
                        ...
                        //显示"重量"值
                        if ((int)(CylinderHeight5 * ((double)dataInterface.IoStStatistics.nWeightGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + k] / uMaxValue2)) > DrawGraphProtocol.StandardCylinderHeight)
                        {
                            g51.TranslateTransform(DrawGraphProtocol.LeftRightSpace + k * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance + DrawGraphProtocol.CylinderWidth,
                            PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance);
                            g51.RotateTransform(-90f);
                            g51.DrawString(dataInterface.IoStStatistics.nWeightGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + k].ToString(),
                                new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
                            g51.ResetTransform();
                        }
                        else
                        {
                            g51.TranslateTransform(DrawGraphProtocol.LeftRightSpace + k * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance + DrawGraphProtocol.CylinderWidth,
                            PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance -
                            (int)(CylinderHeight5 * ((double)dataInterface.IoStStatistics.nWeightGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + k] / uMaxValue2)));
                            g51.RotateTransform(-90f);
                            g51.DrawString(dataInterface.IoStStatistics.nWeightGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + k].ToString(),
                                new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
                            g51.ResetTransform();
                    ...
                    if (uSumValue1 == 0)
                    {
                        ...
                        g51.DrawString("0.00%",
                            new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush,
                            DrawGraphProtocol.LeftRightSpace + k * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module6LeftDistance,
                            PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module6CylinderDistance);
                        //"重量"百分比
                        g51.DrawString("0.00%",
                            new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush,
                            DrawGraphProtocol.LeftRightSpace + k * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module6LeftDistance + DrawGraphProtocol.CylinderWidth,
                            PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module6CylinderDistance);
                    }
                    else
                    {
                        //"个数"百分比
                        g51.DrawString(((double)dataInterface.IoStStatistics.nGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + k] / uSumValue1).ToString("0.00%"),
                            new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush,
                            DrawGraphProtocol.LeftRightSpace + k * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module6LeftDistance,
                            PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - (int)(CylinderHeight5 * ((double)dataInterface.IoStStatistics.nGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + k] / uMaxValue1)) - DrawGraphProtocol.Module6CylinderDistance);
                        //"重量"百分比
                        g51.DrawString(((double)dataInterface.IoStStatistics.nWeightGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + k] / uSumValue2).ToString("0.00%"),
                            new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush,
                            DrawGraphProtocol.LeftRightSpace + k * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module6LeftDistance + DrawGraphProtocol.CylinderWidth,
                            PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - (int)(CylinderHeight5 * ((double)dataInterface.IoStStatistics.nWeightGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + k] / uMaxValue2)) - DrawGraphProtocol.Module6CylinderDistance);
                    }
                ...
                else  //无滚动条时
                {
                    ...
                    g51.DrawString(strSizeName,
                    new Font(DrawGraphProtocol.Module4FontStyle, DrawGraphProtocol.Module4FontSize, FontStyle.Regular),
                    currentBrush, leftRightSpace + k * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace),
                    PicWeight.Height - DrawGraphProtocol.Module4BottomDistance);

                    if (dataInterface.IoStStatistics.nGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + k] == 0)
                    {
                        //"柱体"图形显示
                        g51.FillRectangle(BarBrush, leftRightSpace + k * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace),
                        PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.CylinderHeight4,
                        DrawGraphProtocol.CylinderWidth, DrawGraphProtocol.CylinderHeight4);
                        //"柱体"重量图形显示
                        g51.FillRectangle(BarBrushWeight, leftRightSpace + k * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.CylinderWidth,
                        PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.CylinderHeight4,
                        DrawGraphProtocol.CylinderWidth, DrawGraphProtocol.CylinderHeight4);
                    }
                    else
                    {
                        ...
                        if ((int)(CylinderHeight5 * ((double)dataInterface.IoStStatistics.nGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + k] / uMaxValue1)) > DrawGraphProtocol.StandardCylinderHeight)
                        {
                            g51.TranslateTransform(leftRightSpace + k * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance,
                            PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance);
                            g51.RotateTransform(-90f);
                            g51.DrawString(dataInterface.IoStStatistics.nGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + k].ToString(),
                                new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
                        ...
                        if ((int)(CylinderHeight5 * ((double)dataInterface.IoStStatistics.nWeightGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + k] / uMaxValue2)) > DrawGraphProtocol.StandardCylinderHeight)
                        {
                            g51.TranslateTransform(leftRightSpace + k * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance + DrawGraphProtocol.CylinderWidth,
                            PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance);
                            g51.RotateTransform(-90f);
                            g51.DrawString(dataInterface.IoStStatistics.nWeightGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + k].ToString(),
                                new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
                    ...
                    if (uSumValue1 == 0)
                    {
                        ...
                        g51.DrawString("0.00%",
                            new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush,
                            leftRightSpace + k * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module6LeftDistance,
                            PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module6CylinderDistance);
                        //"重量"百分比
                        g51.DrawString("0.00%",
                            new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush,
                            leftRightSpace + k * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module6LeftDistance + DrawGraphProtocol.CylinderWidth,
                            PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module6CylinderDistance);
                    }
                    else
                    {
            ...
            PicWeight.BackgroundImage = null;  //无此行代码不会刷新，必须加上 Add by ChengSk - 20180821
            PicWeight.BackgroundImage = bitM51;
            #endregion
            ...
            g52.DrawString(m_resourceManager.GetString("LblQualityOfCases.Text"), new Font(DrawGraphProtocol.Module3FontStyle, DrawGraphProtocol.Module3FontSize, FontStyle.Bold),
                currentBrush2, PicBox.Width / 2 - 100, PicBox.Height - DrawGraphProtocol.Module3BottomDistance);
            Int32 nMaxValue2 = 0;  //尺寸最大值
            Int32 nSumValue2 = 0;  //尺寸总值
            for (int i = 0; i < dataInterface.WeightOrSizeGradeSum; i++)
            {
                Int32 temp = dataInterface.IoStStatistics.nBoxGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + i];
                if (nMaxValue2 < temp)
                {
                    nMaxValue2 = temp;
                }
            ...
            for (int i = 0; i < dataInterface.WeightOrSizeGradeSum; i++)
            {
                if (bHaveHscrollBar)  //有滚动条时
                {
                    ...
                    g52.DrawString(Encoding.Default.GetString(dataInterface.IoStStGradeInfo.strSizeGradeName, i * ConstPreDefine.MAX_TEXT_LENGTH, ConstPreDefine.MAX_TEXT_LENGTH),
                        new Font(DrawGraphProtocol.Module4FontStyle, DrawGraphProtocol.Module4FontSize, FontStyle.Regular),
                        currentBrush, DrawGraphProtocol.LeftRightSpace + i * (2 * DrawGraphProtocol.CylinderWidth + CurrentDisplayCylinderSpace),
                        PicBox.Height - DrawGraphProtocol.Module4BottomDistance);

                    if (dataInterface.IoStStatistics.nBoxGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + i] == 0)
                    {
                        //"柱体"图形显示
                        g52.FillRectangle(BarBrush2, DrawGraphProtocol.LeftRightSpace + i * (2 * DrawGraphProtocol.CylinderWidth + CurrentDisplayCylinderSpace),
                    ...
                    else
                    {
                        //"柱体"图形显示  个数
                        g52.FillRectangle(BarBrush2, DrawGraphProtocol.LeftRightSpace + i * (2 * DrawGraphProtocol.CylinderWidth + CurrentDisplayCylinderSpace),
                        PicBox.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - (int)(CylinderHeight5 * ((double)dataInterface.IoStStatistics.nBoxGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + i] / nMaxValue2)),
                        DrawGraphProtocol.CylinderWidth, (int)(CylinderHeight5 * ((double)dataInterface.IoStStatistics.nBoxGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + i] / nMaxValue2)));

                        if ((int)(CylinderHeight5 * ((double)dataInterface.IoStStatistics.nBoxGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + i] / nMaxValue2)) > DrawGraphProtocol.StandardCylinderHeight)
                        {
                            g52.TranslateTransform(DrawGraphProtocol.LeftRightSpace + i * (2 * DrawGraphProtocol.CylinderWidth + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance,
                            ...
                            g52.DrawString(dataInterface.IoStStatistics.nBoxGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + i].ToString(),
                                new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush2, 0, 0);
                            g52.ResetTransform();
                        }
                        else
                        {
                            g52.TranslateTransform(DrawGraphProtocol.LeftRightSpace + i * (2 * DrawGraphProtocol.CylinderWidth + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance,
                            PicBox.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance -
                            (int)(CylinderHeight5 * ((double)dataInterface.IoStStatistics.nBoxGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + i] / nMaxValue2)));
                            g52.RotateTransform(-90f);
                            g52.DrawString(dataInterface.IoStStatistics.nBoxGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + i].ToString(),
                                new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush2, 0, 0);
                            g52.ResetTransform();
                    ...
                    if (nSumValue2 == 0)
                    {
                        //百分比
                        g52.DrawString("0.00%",
                            new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush2,
                            DrawGraphProtocol.LeftRightSpace + i * (2 * DrawGraphProtocol.CylinderWidth + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module6LeftDistance,
                    ...
                    {
                        //百分比
                        g52.DrawString(((double)dataInterface.IoStStatistics.nBoxGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + i] / nSumValue2).ToString("0.00%"),
                            new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush2,
                            DrawGraphProtocol.LeftRightSpace + i * (2 * DrawGraphProtocol.CylinderWidth + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module6LeftDistance,
                ...
                else  //无滚动条时
                {
                    ...
                    g52.DrawString(Encoding.Default.GetString(dataInterface.IoStStGradeInfo.strSizeGradeName, i * ConstPreDefine.MAX_TEXT_LENGTH, ConstPreDefine.MAX_TEXT_LENGTH),
                        new Font(DrawGraphProtocol.Module4FontStyle, DrawGraphProtocol.Module4FontSize, FontStyle.Regular),
                        currentBrush2, leftRightSpace + i * (2 * DrawGraphProtocol.CylinderWidth + CurrentDisplayCylinderSpace),
                        PicBox.Height - DrawGraphProtocol.Module4BottomDistance);
                    ...
                    {
                        //"柱体"图形显示
                        g52.FillRectangle(BarBrush2, leftRightSpace + i * (2 * DrawGraphProtocol.CylinderWidth + CurrentDisplayCylinderSpace),
                        PicBox.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.CylinderHeight4,
                        DrawGraphProtocol.CylinderWidth, DrawGraphProtocol.CylinderHeight4);
                    }
                    else
                    {
                        ...
                        if ((int)(CylinderHeight5 * ((double)dataInterface.IoStStatistics.nBoxGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + i] / nMaxValue2)) > DrawGraphProtocol.StandardCylinderHeight)
                        {
                            g52.TranslateTransform(leftRightSpace + i * (2 * DrawGraphProtocol.CylinderWidth + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance,
                            PicBox.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance);
                            g52.RotateTransform(-90f);
                            g52.DrawString(dataInterface.IoStStatistics.nBoxGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + i].ToString(),
                                new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush2, 0, 0);
                    ...
                    if (nSumValue2 == 0)
                    {
                        ...
                        g52.DrawString("0.00%",
                            new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush2,
                            leftRightSpace + i * (2 * DrawGraphProtocol.CylinderWidth + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module6LeftDistance,
                            PicBox.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module6CylinderDistance);
                    }
                    else
                    {
                        ...
                        g52.DrawString(((double)dataInterface.IoStStatistics.nBoxGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + i] / nSumValue2).ToString("0.00%"),
                            new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush2,
                            leftRightSpace + i * (2 * DrawGraphProtocol.CylinderWidth + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module6LeftDistance,
                            PicBox.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - (int)(CylinderHeight5 * ((double)dataInterface.IoStStatistics.nBoxGradeCount[CboWeightType.SelectedIndex * ConstPreDefine.MAX_SIZE_GRADE_NUM + i] / nMaxValue2)) - DrawGraphProtocol.Module6CylinderDistance);
                    }
        ...
        {
            //CboWeightType清空
            CboWeightType.Items.Clear();

            #region 往CboWeightType中插入数据
            ...
            for (int i = 0; i < dataInterface.QualityGradeSum; i++)
            {
                ...
                CboWeightType.Items.Add(strQualityName);
            }
            #endregion

            //设定当前选中项
            CboWeightType.SelectedIndex = currentSelectIndex;
            ...
            //#region 界面设定
            //if ((dataInterface.QualityGradeSum * dataInterface.WeightOrSizeGradeSum - 1) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) +
            //    DrawGraphProtocol.CylinderWidth * 2 + DrawGraphProtocol.Module2RightDistance < tabPage5.Width)  //无需使用滚动条
            //{
            //    bHaveHscrollBar = false;
            //    hScrollBar5.Visible = false;
            //    PicWeight.Dock = DockStyle.Fill;
            //    CylinderHeight5 = DrawGraphProtocol.CylinderHeight2;
            //    leftRightSpace = (PicWeight.Width - (dataInterface.QualityGradeSum * dataInterface.WeightOrSizeGradeSum - 1) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) -
            //        DrawGraphProtocol.CylinderWidth * 2 - DrawGraphProtocol.Module2RightDistance) / 2;
            //}
            //else  //需要使用滚动条
            //{
            //    bHaveHscrollBar = true;
            //    PicWeight.Width = (dataInterface.QualityGradeSum * dataInterface.WeightOrSizeGradeSum - 1) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) +
            //        DrawGraphProtocol.CylinderWidth * 2 + 2 * DrawGraphProtocol.LeftRightSpace + DrawGraphProtocol.Module2RightDistance;
            //    hScrollBar5.Maximum = PicWeight.Width - tabPage5.Width;
            //    CylinderHeight5 = DrawGraphProtocol.CylinderHeight1;
            //}
            //#endregion
            ...
            ////    currentBrush, DrawGraphProtocol.Module1LocationX, DrawGraphProtocol.Module1LocationY);
            ////"出口统计信息"字样
            //g.DrawString(m_resourceManager.GetString("tabPage5.Text"), new Font(DrawGraphProtocol.Module3FontStyle, DrawGraphProtocol.Module3FontSize, FontStyle.Bold),
            //    currentBrush, PicWeight.Width / 2 - DrawGraphProtocol.Module3MiddleDistance, PicWeight.Height - DrawGraphProtocol.Module3BottomDistance);
            //#endregion
            ...
            //            new Font(DrawGraphProtocol.Module4FontStyle, DrawGraphProtocol.Module4FontSize, FontStyle.Regular),
            //            currentBrush, DrawGraphProtocol.LeftRightSpace + (i * dataInterface.WeightOrSizeGradeSum + j) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace),
            //            PicWeight.Height - DrawGraphProtocol.Module4BottomDistance);

            //            if (dataInterface.IoStStatistics.nGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j] == 0)
            //            {
            //                //"柱体"图形显示
            //                g.FillRectangle(BarBrush, DrawGraphProtocol.LeftRightSpace + (i * dataInterface.WeightOrSizeGradeSum + j) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace),
            //                PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.CylinderHeight4,
            //                DrawGraphProtocol.CylinderWidth, DrawGraphProtocol.CylinderHeight4);
            //                //"柱体"重量图形显示
            //                g.FillRectangle(BarBrushWeight, DrawGraphProtocol.LeftRightSpace + (i * dataInterface.WeightOrSizeGradeSum + j) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.CylinderWidth,
            //                PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.CylinderHeight4,
            //                DrawGraphProtocol.CylinderWidth, DrawGraphProtocol.CylinderHeight4);
            //            }
            //            else
            ...
            //                //"柱体"图形显示  个数
            //                g.FillRectangle(BarBrush, DrawGraphProtocol.LeftRightSpace + (i * dataInterface.WeightOrSizeGradeSum + j) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace),
            //                PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - (int)(CylinderHeight5 * ((double)dataInterface.IoStStatistics.nGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j] / uMaxValue1)),
            //                DrawGraphProtocol.CylinderWidth, (int)(CylinderHeight5 * ((double)dataInterface.IoStStatistics.nGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j] / uMaxValue1)));
            //                //"柱体"重量图形显示
            //                g.FillRectangle(BarBrushWeight, DrawGraphProtocol.LeftRightSpace + (i * dataInterface.WeightOrSizeGradeSum + j) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.CylinderWidth,
            //                PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - (int)(CylinderHeight5 * ((double)dataInterface.IoStStatistics.nWeightGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j] / uMaxValue2)),
            //                DrawGraphProtocol.CylinderWidth, (int)(CylinderHeight5 * ((double)dataInterface.IoStStatistics.nWeightGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j] / uMaxValue2)));
                            
            //                //显示"个数"值
            //                if ((int)(CylinderHeight5 * ((double)dataInterface.IoStStatistics.nGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j] / uMaxValue1)) > DrawGraphProtocol.StandardCylinderHeight)
            //                {
            //                    g.TranslateTransform(DrawGraphProtocol.LeftRightSpace + (i * dataInterface.WeightOrSizeGradeSum + j) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance,
            //                    PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance);
            //                    g.RotateTransform(-90f);
            //                    g.DrawString(dataInterface.IoStStatistics.nGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j].ToString(),
            //                        new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
            //                    g.ResetTransform();
            //                }
            //                else
            ...
            //                    g.TranslateTransform(DrawGraphProtocol.LeftRightSpace + (i * dataInterface.WeightOrSizeGradeSum + j) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance,
            //                    PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance-
            //                    (int)(CylinderHeight5 * ((double)dataInterface.IoStStatistics.nGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j] / uMaxValue1)));
            //                    g.RotateTransform(-90f);
            //                    g.DrawString(dataInterface.IoStStatistics.nGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j].ToString(),
            //                        new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
            //                    g.ResetTransform();
            ...
            //                //显示"重量"值
            //                if ((int)(CylinderHeight5 * ((double)dataInterface.IoStStatistics.nWeightGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j] / uMaxValue2)) > DrawGraphProtocol.StandardCylinderHeight)
            //                {
            //                    g.TranslateTransform(DrawGraphProtocol.LeftRightSpace + (i * dataInterface.WeightOrSizeGradeSum + j) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance + DrawGraphProtocol.CylinderWidth,
            //                    PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance);
            //                    g.RotateTransform(-90f);
            //                    g.DrawString(dataInterface.IoStStatistics.nWeightGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j].ToString(),
            //                        new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
            //                    g.ResetTransform();
            //                }
            //                else
            ...
            //                    g.TranslateTransform(DrawGraphProtocol.LeftRightSpace + (i * dataInterface.WeightOrSizeGradeSum + j) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance + DrawGraphProtocol.CylinderWidth,
            //                    PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance-
            //                    (int)(CylinderHeight5 * ((double)dataInterface.IoStStatistics.nWeightGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j] / uMaxValue2)));
            //                    g.RotateTransform(-90f);
            //                    g.DrawString(dataInterface.IoStStatistics.nWeightGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j].ToString(),
            //                        new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
            //                    g.ResetTransform();
            ...
            //                g.DrawString("0.00%",
            //                    new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush,
            //                    DrawGraphProtocol.LeftRightSpace + (i * dataInterface.WeightOrSizeGradeSum + j) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module6LeftDistance,
            //                    PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module6CylinderDistance);
            //                //"重量"百分比
            //                g.DrawString("0.00%",
            //                    new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush,
            //                    DrawGraphProtocol.LeftRightSpace + (i * dataInterface.WeightOrSizeGradeSum + j) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module6LeftDistance + DrawGraphProtocol.CylinderWidth,
            //                    PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module6CylinderDistance);         
            //            }
            //            else
            //            {
            //                //"个数"百分比
            //                g.DrawString(((double)dataInterface.IoStStatistics.nGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j] / uSumValue1).ToString("0.00%"),
            //                    new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush,
            //                    DrawGraphProtocol.LeftRightSpace + (i * dataInterface.WeightOrSizeGradeSum + j) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module6LeftDistance,
            //                    PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - (int)(CylinderHeight5 * ((double)dataInterface.IoStStatistics.nGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j] / uMaxValue1)) - DrawGraphProtocol.Module6CylinderDistance);
            //                //"重量"百分比
            //                g.DrawString(((double)dataInterface.IoStStatistics.nWeightGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j] / uSumValue2).ToString("0.00%"),
            //                    new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush,
            //                    DrawGraphProtocol.LeftRightSpace + (i * dataInterface.WeightOrSizeGradeSum + j) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module6LeftDistance + DrawGraphProtocol.CylinderWidth,
            //                    PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - (int)(CylinderHeight5 * ((double)dataInterface.IoStStatistics.nWeightGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j] / uMaxValue2)) - DrawGraphProtocol.Module6CylinderDistance);
            //            }
            ...
            //            g.DrawString(strMixName,
            //            new Font(DrawGraphProtocol.Module4FontStyle, DrawGraphProtocol.Module4FontSize, FontStyle.Regular),
            //            currentBrush, leftRightSpace + (i * dataInterface.WeightOrSizeGradeSum + j) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace),
            //            PicWeight.Height - DrawGraphProtocol.Module4BottomDistance);

            //            if (dataInterface.IoStStatistics.nGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j] == 0)
            //            {
            //                //"柱体"图形显示
            //                g.FillRectangle(BarBrush, leftRightSpace + (i * dataInterface.WeightOrSizeGradeSum + j) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace),
            //                PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.CylinderHeight4,
            //                DrawGraphProtocol.CylinderWidth, DrawGraphProtocol.CylinderHeight4);
            //                //"柱体"重量图形显示
            //                g.FillRectangle(BarBrushWeight, leftRightSpace + (i * dataInterface.WeightOrSizeGradeSum + j) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.CylinderWidth,
            //                PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.CylinderHeight4,
            //                DrawGraphProtocol.CylinderWidth, DrawGraphProtocol.CylinderHeight4);
            //            }
            //            else
            ...
            //                if ((int)(CylinderHeight5 * ((double)dataInterface.IoStStatistics.nGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j] / uMaxValue1)) > DrawGraphProtocol.StandardCylinderHeight)
            //                {
            //                    g.TranslateTransform(leftRightSpace + (i * dataInterface.WeightOrSizeGradeSum + j) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance,
            //                    PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance);
            //                    g.RotateTransform(-90f);
            //                    g.DrawString(dataInterface.IoStStatistics.nGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j].ToString(),
            //                        new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
            ...
            //                if ((int)(CylinderHeight5 * ((double)dataInterface.IoStStatistics.nWeightGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j] / uMaxValue2)) > DrawGraphProtocol.StandardCylinderHeight)
            //                {
            //                    g.TranslateTransform(leftRightSpace + (i * dataInterface.WeightOrSizeGradeSum + j) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance + DrawGraphProtocol.CylinderWidth,
            //                    PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance);
            //                    g.RotateTransform(-90f);
            //                    g.DrawString(dataInterface.IoStStatistics.nWeightGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j].ToString(),
            //                        new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
            ...
            //                g.DrawString("0.00%",
            //                    new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush,
            //                    leftRightSpace + (i * dataInterface.WeightOrSizeGradeSum + j) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module6LeftDistance,
            //                    PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module6CylinderDistance);
            //                //"重量"百分比
            //                g.DrawString("0.00%",
            //                    new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush,
            //                    leftRightSpace + (i * dataInterface.WeightOrSizeGradeSum + j) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module6LeftDistance + DrawGraphProtocol.CylinderWidth,
            //                    PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module6CylinderDistance);  
            //            }
            //            else
            //            {
            ...
            //PicWeight.BackgroundImage = bitM;
            #endregion
        }

        private void hScrollBar5_Scroll(object sender, ScrollEventArgs e)
        {
            PicWeight.Left = -hScrollBar5.Value;
        ...
        //    bool bHaveHscrollBar;     //是否有滚动条
        //    int leftRightSpace = 0;   //柱体离左右边框距离
        //    Int32 uMaxValue = 0;      //各等级"箱数"最大值
        //    Int32 uSumValue = 0;      //各等级"箱数"总值
        //    string strSizeName;       //"重量等级"名称
        //    string strQualityName;    //"品质等级"名称
        //    string strMixName;        //混合名称：重量名称.品质名称
        //    #endregion
        ...
        //        leftRightSpace = (PicBox.Width - (dataInterface.QualityGradeSum * dataInterface.WeightOrSizeGradeSum - 1) * (DrawGraphProtocol.CylinderWidth + CurrentDisplayCylinderSpace) -
        //            DrawGraphProtocol.CylinderWidth) / 2;
        //    }
        //    else  //需要使用滚动条
        //    {
        //        bHaveHscrollBar = true;
        //        PicBox.Width = (dataInterface.QualityGradeSum * dataInterface.WeightOrSizeGradeSum - 1) * (DrawGraphProtocol.CylinderWidth + CurrentDisplayCylinderSpace) +
        //            DrawGraphProtocol.CylinderWidth + 2 * DrawGraphProtocol.LeftRightSpace;
        //        hScrollBar6.Maximum = PicBox.Width - tabPage6.Width;
        ...
        //                    //"柱体"图形显示  个数
        //                    g.FillRectangle(BarBrush, DrawGraphProtocol.LeftRightSpace + (i * dataInterface.WeightOrSizeGradeSum + j) * (DrawGraphProtocol.CylinderWidth + CurrentDisplayCylinderSpace),
        //                    PicBox.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - (int)(CylinderHeight6 * ((double)dataInterface.IoStStatistics.nBoxGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j] / uMaxValue)),
        ...
        //                        new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush,
        //                        DrawGraphProtocol.LeftRightSpace + (i * dataInterface.WeightOrSizeGradeSum + j) * (DrawGraphProtocol.CylinderWidth + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module6LeftDistance,
        //                        PicBox.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - (int)(CylinderHeight6 * ((double)dataInterface.IoStStatistics.nBoxGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j] / uMaxValue)) - DrawGraphProtocol.Module6CylinderDistance);
        //                }
                        ...
                        if (dlg.ShowDialog() == DialogResult.OK)
                        {
                            ...
                            switch (tabControl1.SelectedIndex)
                            {
                                ...
                                case 3:
                                    ...
                                    break;
                                case 4:
                                    PicWeight.BackgroundImage.Save(picsizefilename);
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            switch (tabControl1.SelectedIndex)
            {
                case 0:
                    ...
                    string barHead0 = m_resourceManager.GetString("LblPrintNOrWPercenet.Text");
                    ...
                    //Graphics g = Graphics.FromImage(bitM0);
                    ...
                    Brush myBarBrush0 = new SolidBrush(PrintProtocol.barBrush2);
                    Brush myBarBrushWeight0 = new SolidBrush(PrintProtocol.barBrush3);
                    //界面设定
                    if ((dataInterface.ExportSum - 1) * (PrintProtocol.cylinderWidth1 * 2 + PrintProtocol.cylinderSpace1) + PrintProtocol.cylinderWidth1 * 2 + PrintProtocol.ModuleRightDistance < PrintProtocol.barImageWidht)
                    {
                        cylinderWidth = PrintProtocol.cylinderWidth1;
                        cylinderSpace = PrintProtocol.cylinderSpace1;
                        cylinderLeftMargin = (PrintProtocol.barImageWidht - (dataInterface.ExportSum - 1) * (PrintProtocol.cylinderWidth1 * 2 + PrintProtocol.cylinderSpace1) - PrintProtocol.cylinderWidth1 * 2 - PrintProtocol.ModuleRightDistance) / 2;
                    ...
                    else
                    {
                        ...
                        cylinderWidth = (PrintProtocol.barImageWidht - (dataInterface.ExportSum - 1) * 5 - PrintProtocol.ModuleRightDistance) / dataInterface.ExportSum / 2;
                        cylinderSpace = 5;
                        cylinderLeftMargin = (PrintProtocol.barImageWidht - (dataInterface.ExportSum - 1) * (cylinderWidth * 2 + cylinderSpace) - cylinderWidth * 2 - PrintProtocol.ModuleRightDistance) / 2;
                        cylinderDigitLeftDistance = PrintProtocol.cylinderDigitLeftDistance2;
                    }
                    //框 柱体1 柱体2 个数 重量(颜色框字样)
                    e.Graphics.DrawRectangle(new Pen(Color.Black), PrintProtocol.barImageWidht - PrintProtocol.ModuleRightDistance, PrintProtocol.barImageHeight / 2 - PrintProtocol.ModuleMiddleDistance,
                        PrintProtocol.ModuleFrameWidth, PrintProtocol.ModuleFrameHeight);
                    e.Graphics.FillRectangle(myBarBrush0,
                        PrintProtocol.barImageWidht - PrintProtocol.ModuleRightDistance + PrintProtocol.ModuleSmallGraphHorizontalSpace,
                        PrintProtocol.barImageHeight / 2 - PrintProtocol.ModuleMiddleDistance + PrintProtocol.ModuleSmallGraphVerticalSpace,
                        PrintProtocol.ModuleSmallCylinderWidth, PrintProtocol.ModuleSmallCylinderHeight);
                    e.Graphics.FillRectangle(myBarBrushWeight0,
                        PrintProtocol.barImageWidht - PrintProtocol.ModuleRightDistance + PrintProtocol.ModuleSmallGraphHorizontalSpace,
                        PrintProtocol.barImageHeight / 2 - PrintProtocol.ModuleMiddleDistance + PrintProtocol.ModuleSmallGraphVerticalSpace * 2 + PrintProtocol.ModuleSmallCylinderHeight,
                        PrintProtocol.ModuleSmallCylinderWidth, PrintProtocol.ModuleSmallCylinderHeight);
                    e.Graphics.DrawString(m_resourceManager.GetString("LblPieces.Text"), new Font(PrintProtocol.ModuleFontStyle, PrintProtocol.ModuleFontSize, FontStyle.Regular), myCurrentBrush0,
                        PrintProtocol.barImageWidht - PrintProtocol.ModuleRightDistance + PrintProtocol.ModuleSmallGraphHorizontalSpace + PrintProtocol.ModuleSmallCylinderWidth + PrintProtocol.ModuleFontHorizontalSpace,
                        PrintProtocol.barImageHeight / 2 - PrintProtocol.ModuleMiddleDistance + PrintProtocol.ModuleSmallGraphVerticalSpace + PrintProtocol.ModuleFontVerticalSpace);
                    e.Graphics.DrawString(m_resourceManager.GetString("LblWeight.Text"), new Font(PrintProtocol.ModuleFontStyle, PrintProtocol.ModuleFontSize, FontStyle.Regular), myCurrentBrush0,
                        PrintProtocol.barImageWidht - PrintProtocol.ModuleRightDistance + PrintProtocol.ModuleSmallGraphHorizontalSpace + PrintProtocol.ModuleSmallCylinderWidth + PrintProtocol.ModuleFontHorizontalSpace,
                        PrintProtocol.barImageHeight / 2 - PrintProtocol.ModuleMiddleDistance + PrintProtocol.ModuleSmallGraphVerticalSpace * 2 + PrintProtocol.ModuleFontVerticalSpace + PrintProtocol.ModuleSmallCylinderHeight);
                    UInt64 uMaxValueNumber0 = FunctionInterface.GetMaxValue(dataInterface.IoStStatistics.nExitCount);//个数最大值
                    UInt64 uSumValueNumber0 = FunctionInterface.GetSumValue(dataInterface.IoStStatistics.nExitCount);//个数总值
                    UInt64 uMaxValueWeight0 = FunctionInterface.GetMaxValue(dataInterface.IoStStatistics.nExitWeightCount);//重量最大值
                    UInt64 uSumValueWeight0 = FunctionInterface.GetSumValue(dataInterface.IoStStatistics.nExitWeightCount);//重量总值
                    for (int i = 0; i < dataInterface.ExportSum; i++)
                    {
                        //柱形图下标字样
                        e.Graphics.DrawString((i + 1).ToString(), new Font("Times New Roman", 10, FontStyle.Regular), myCurrentBrush0,
                            cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace),
                            PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin + PrintProtocol.cylinderOrTextNote);
                        if (dataInterface.IoStStatistics.nExitCount[i] == 0)
                        {
                            //柱形图个数
                            e.Graphics.FillRectangle(myBarBrush0, cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace),
                            ...
                            //柱形图重量
                            e.Graphics.FillRectangle(myBarBrushWeight0, cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth,
                                PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - PrintProtocol.cylinderMinHeight,
                                cylinderWidth, PrintProtocol.cylinderMinHeight);
                        }
                        else
                        {
                            //柱形图个数
                            e.Graphics.FillRectangle(myBarBrush0, cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace),
                                PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)dataInterface.IoStStatistics.nExitCount[i] / uMaxValueNumber0)),
                                cylinderWidth, (int)(PrintProtocol.cylinderMaxHeight * ((double)dataInterface.IoStStatistics.nExitCount[i] / uMaxValueNumber0)));
                            //柱形图重量
                            e.Graphics.FillRectangle(myBarBrushWeight0, cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth,
                                PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)dataInterface.IoStStatistics.nExitWeightCount[i] / uMaxValueWeight0)),
                                cylinderWidth, (int)(PrintProtocol.cylinderMaxHeight * ((double)dataInterface.IoStStatistics.nExitWeightCount[i] / uMaxValueWeight0)));
                            //显示个数值
                            if ((int)(PrintProtocol.cylinderMaxHeight * ((double)dataInterface.IoStStatistics.nExitCount[i] / uMaxValueNumber0)) > PrintProtocol.cylinderStandardCylinderHeigh)
                            {
                                e.Graphics.TranslateTransform(cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderDigitLeftDistance,
                            ...
                            {
                                e.Graphics.TranslateTransform(cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderDigitLeftDistance,
                                    PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)dataInterface.IoStStatistics.nExitCount[i] / uMaxValueNumber0)) - PrintProtocol.cylinderDigitBottomDistance);
                                e.Graphics.RotateTransform(-90f);
                                e.Graphics.DrawString(dataInterface.IoStStatistics.nExitCount[i].ToString(),
                                    new Font("Times New Roman", 10, FontStyle.Bold), myCurrentBrush0, 0, 0);
                                e.Graphics.ResetTransform();
                            ...
                            //显示重量值
                            if ((int)(PrintProtocol.cylinderMaxHeight * ((double)dataInterface.IoStStatistics.nExitWeightCount[i] / uMaxValueWeight0)) > PrintProtocol.cylinderStandardCylinderHeigh)
                            {
                                e.Graphics.TranslateTransform(cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth + cylinderDigitLeftDistance,
                                    PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - cylinderDigitLeftDistance);
                                e.Graphics.RotateTransform(-90f);
                                e.Graphics.DrawString(dataInterface.IoStStatistics.nExitWeightCount[i].ToString(),
                                    new Font("Times New Roman", 10, FontStyle.Bold), myCurrentBrush0, 0, 0);
                                e.Graphics.ResetTransform();
                                e.Graphics.TranslateTransform(PrintProtocol.leftMargin, currentAvailableHeight);
                            }
                            ...
                            {
                                e.Graphics.TranslateTransform(cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth + cylinderDigitLeftDistance,
                                    PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)dataInterface.IoStStatistics.nExitWeightCount[i] / uMaxValueWeight0)) - PrintProtocol.cylinderDigitBottomDistance);
                                e.Graphics.RotateTransform(-90f);
                                e.Graphics.DrawString(dataInterface.IoStStatistics.nExitWeightCount[i].ToString(),
                                    new Font("Times New Roman", 10, FontStyle.Bold), myCurrentBrush0, 0, 0);
                                e.Graphics.ResetTransform();
                        ...
                        if (uSumValueNumber0 == 0)
                        {
                            //个数百分比
                            e.Graphics.DrawString("0.00%", new Font("Times New Roman", 10, FontStyle.Regular), myCurrentBrush0,
                                cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + PrintProtocol.cylinderPrecentLeftDistance,
                            ...
                            //重量百分比
                            e.Graphics.DrawString("0.00%", new Font("Times New Roman", 10, FontStyle.Regular), myCurrentBrush0,
                                cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth + PrintProtocol.cylinderPrecentLeftDistance,
                                PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - PrintProtocol.cylinderMinHeight - PrintProtocol.cylinderPrecentBottomDistance);
                        }
                        else
                        {
                            //个数百分比
                            e.Graphics.DrawString(((double)dataInterface.IoStStatistics.nExitCount[i] / uSumValueNumber0).ToString("0.00%"),
                                new Font("Times New Roman", 10, FontStyle.Regular), myCurrentBrush0,
                                cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + PrintProtocol.cylinderPrecentLeftDistance,
                                PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)dataInterface.IoStStatistics.nExitCount[i] / uMaxValueNumber0)) - PrintProtocol.cylinderPrecentBottomDistance);
                            //重量百分比
                            e.Graphics.DrawString(((double)dataInterface.IoStStatistics.nExitWeightCount[i] / uSumValueWeight0).ToString("0.00%"),
                                new Font("Times New Roman", 10, FontStyle.Regular), myCurrentBrush0,
                                cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth + PrintProtocol.cylinderPrecentLeftDistance,
                                PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)dataInterface.IoStStatistics.nExitWeightCount[i] / uMaxValueWeight0)) - PrintProtocol.cylinderPrecentBottomDistance);
                        }
                    }
                    e.Graphics.ResetTransform();
                    //try
                    ...
                    Font barTitleFont0 = new Font("楷体_GB2312", 18, FontStyle.Bold);
                    Brush barTitleBrush0 = Brushes.Black;
                    string barTitle0 = m_resourceManager.GetString("tabPage1.Text");
                    XMaxSize0 = TitG0.MeasureString(barTitle0, barTitleFont0);
                    e.Graphics.DrawString(//使用DrawString方法绘制条形图标题字符串
                        barTitle0, barTitleFont0, barTitleBrush0, (e.PageBounds.Width - PrintProtocol.leftMargin - PrintProtocol.rightMargin - XMaxSize0.Width) / 2 + PrintProtocol.leftMargin,
                        currentAvailableHeight);
                    #endregion
                ...
                case 1:
                    ...
                    string barHead1 = m_resourceManager.GetString("LblPrintNOrWPercenet.Text");
                    ...
                    Brush myBarBrush1 = new SolidBrush(PrintProtocol.barBrush2);
                    Brush myBarBrushWeight1 = new SolidBrush(PrintProtocol.barBrush3);
                    //界面设定
                    if ((dataInterface.QualityGradeSum - 1) * (PrintProtocol.cylinderWidth1 * 2 + PrintProtocol.cylinderSpace1) + PrintProtocol.cylinderWidth1 * 2 + PrintProtocol.ModuleRightDistance < PrintProtocol.barImageWidht)
                    {
                        cylinderWidth = PrintProtocol.cylinderWidth1;
                        cylinderSpace = PrintProtocol.cylinderSpace1;
                        cylinderLeftMargin = (PrintProtocol.barImageWidht - (dataInterface.QualityGradeSum - 1) * (PrintProtocol.cylinderWidth1 * 2 + PrintProtocol.cylinderSpace1) - PrintProtocol.cylinderWidth1 * 2 - PrintProtocol.ModuleRightDistance) / 2;
                        cylinderDigitLeftDistance = PrintProtocol.cylinderDigitLeftDistance1;
                    }
                    else
                    {
                        //cylinderWidth = PrintProtocol.cylinderWidth2;
                        //cylinderSpace = PrintProtocol.cylinderSpace2;
                        cylinderWidth = (PrintProtocol.barImageWidht - (dataInterface.QualityGradeSum - 1) * 5 - PrintProtocol.ModuleRightDistance) / dataInterface.ExportSum / 2;
                        cylinderSpace = 5;
                        cylinderLeftMargin = (PrintProtocol.barImageWidht - (dataInterface.QualityGradeSum - 1) * (cylinderWidth * 2 + cylinderSpace) - cylinderWidth * 2 - PrintProtocol.ModuleRightDistance) / 2;
                        cylinderDigitLeftDistance = PrintProtocol.cylinderDigitLeftDistance2;
                    }
                    //框 柱体1 柱体2 个数 重量(颜色框字样)
                    e.Graphics.DrawRectangle(new Pen(Color.Black), PrintProtocol.barImageWidht - PrintProtocol.ModuleRightDistance, PrintProtocol.barImageHeight / 2 - PrintProtocol.ModuleMiddleDistance,
                        PrintProtocol.ModuleFrameWidth, PrintProtocol.ModuleFrameHeight);
                    e.Graphics.FillRectangle(myBarBrush1,
                        PrintProtocol.barImageWidht - PrintProtocol.ModuleRightDistance + PrintProtocol.ModuleSmallGraphHorizontalSpace,
                        PrintProtocol.barImageHeight / 2 - PrintProtocol.ModuleMiddleDistance + PrintProtocol.ModuleSmallGraphVerticalSpace,
                        PrintProtocol.ModuleSmallCylinderWidth, PrintProtocol.ModuleSmallCylinderHeight);
                    e.Graphics.FillRectangle(myBarBrushWeight1,
                        PrintProtocol.barImageWidht - PrintProtocol.ModuleRightDistance + PrintProtocol.ModuleSmallGraphHorizontalSpace,
                        PrintProtocol.barImageHeight / 2 - PrintProtocol.ModuleMiddleDistance + PrintProtocol.ModuleSmallGraphVerticalSpace * 2 + PrintProtocol.ModuleSmallCylinderHeight,
                        PrintProtocol.ModuleSmallCylinderWidth, PrintProtocol.ModuleSmallCylinderHeight);
                    e.Graphics.DrawString(m_resourceManager.GetString("LblPieces.Text"), new Font(PrintProtocol.ModuleFontStyle, PrintProtocol.ModuleFontSize, FontStyle.Regular), myCurrentBrush1,
                        PrintProtocol.barImageWidht - PrintProtocol.ModuleRightDistance + PrintProtocol.ModuleSmallGraphHorizontalSpace + PrintProtocol.ModuleSmallCylinderWidth + PrintProtocol.ModuleFontHorizontalSpace,
                        PrintProtocol.barImageHeight / 2 - PrintProtocol.ModuleMiddleDistance + PrintProtocol.ModuleSmallGraphVerticalSpace + PrintProtocol.ModuleFontVerticalSpace);
                    e.Graphics.DrawString(m_resourceManager.GetString("LblWeight.Text"), new Font(PrintProtocol.ModuleFontStyle, PrintProtocol.ModuleFontSize, FontStyle.Regular), myCurrentBrush1,
                        PrintProtocol.barImageWidht - PrintProtocol.ModuleRightDistance + PrintProtocol.ModuleSmallGraphHorizontalSpace + PrintProtocol.ModuleSmallCylinderWidth + PrintProtocol.ModuleFontHorizontalSpace,
                        PrintProtocol.barImageHeight / 2 - PrintProtocol.ModuleMiddleDistance + PrintProtocol.ModuleSmallGraphVerticalSpace * 2 + PrintProtocol.ModuleFontVerticalSpace + PrintProtocol.ModuleSmallCylinderHeight);
                    UInt64 totalFruitNumber1 = 0;  //每品质水果的总个数
                    UInt64 maxFruitNumber1 = 0;    //所有品质中水果总个数最大值
                    UInt64 totalFruitWeight1 = 0;  //每品质水果的总重量
                    UInt64 maxFruitWeight1 = 0;    //所有品质中水果总重量最大值
                    //找各品质中水果个数最大值
                    for (int i = 0; i < dataInterface.QualityGradeSum; i++)
                    {
                        UInt64 temp = 0;
                    ...
                    for (int i = 0; i < dataInterface.QualityGradeSum; i++)
                    {
                        ...
                        if (maxFruitWeight1 < temp)
                        {
                            maxFruitWeight1 = temp;
                        }
                    }
                    for (int i = 0; i < dataInterface.QualityGradeSum; i++)
                    {
                        ...
                        for (int j = 0; j < dataInterface.WeightOrSizeGradeSum; j++)
                        {
                            totalFruitNumber1 += dataInterface.IoStStatistics.nGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j];
                            totalFruitWeight1 += dataInterface.IoStStatistics.nWeightGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j];
                        }
                        if (totalFruitNumber1 == 0)
                        {
                            //柱形图个数
                            e.Graphics.FillRectangle(myBarBrush1, cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace),
                                PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - PrintProtocol.cylinderMinHeight,
                                cylinderWidth, PrintProtocol.cylinderMinHeight);
                            //柱形图重量
                            e.Graphics.FillRectangle(myBarBrushWeight1, cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth,
                                PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - PrintProtocol.cylinderMinHeight,
                                cylinderWidth, PrintProtocol.cylinderMinHeight);
                        }
                        else
                        {
                            ...
                            //柱形图重量
                            e.Graphics.FillRectangle(myBarBrushWeight1, cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth,
                                PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)totalFruitWeight1 / maxFruitWeight1)),
                                cylinderWidth, (int)(PrintProtocol.cylinderMaxHeight * ((double)totalFruitWeight1 / maxFruitWeight1)));
                            //显示个数值
                            ...
                            //显示重量值
                            if ((int)(PrintProtocol.cylinderMaxHeight * ((double)totalFruitWeight1 / maxFruitWeight1)) > PrintProtocol.cylinderStandardCylinderHeigh)
                            {
                                e.Graphics.TranslateTransform(cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth + cylinderDigitLeftDistance,
                                    PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - cylinderDigitLeftDistance);
                                e.Graphics.RotateTransform(-90f);
                                e.Graphics.DrawString(totalFruitWeight1.ToString(),
                                    new Font("Times New Roman", 10, FontStyle.Bold), myCurrentBrush1, 0, 0);
                                e.Graphics.ResetTransform();
                                e.Graphics.TranslateTransform(PrintProtocol.leftMargin, currentAvailableHeight);
                            }
                            ...
                            {
                                e.Graphics.TranslateTransform(cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth + cylinderDigitLeftDistance,
                                    PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)totalFruitWeight1 / maxFruitWeight1)) - PrintProtocol.cylinderDigitBottomDistance);
                                e.Graphics.RotateTransform(-90f);
                                e.Graphics.DrawString(totalFruitWeight1.ToString(),
                                    new Font("Times New Roman", 10, FontStyle.Bold), myCurrentBrush1, 0, 0);
                                e.Graphics.ResetTransform();
                        ...
                        else
                        {
                            ...
                            //重量百分比
                            e.Graphics.DrawString(((double)totalFruitWeight1 / dataInterface.IoStStatistics.nWeightCount).ToString("0.00%"),
                                new Font("Times New Roman", 10, FontStyle.Regular), myCurrentBrush1,
                                cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth + PrintProtocol.cylinderPrecentLeftDistance,
                                PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)totalFruitWeight1 / maxFruitWeight1)) - PrintProtocol.cylinderPrecentBottomDistance);
                        }
                        totalFruitNumber1 = 0;
                        totalFruitWeight1 = 0;
                    }
                ...
                case 2:
                    ...
                    string barHead2 = m_resourceManager.GetString("LblPrintNOrWPercenet.Text");
                    ...
                    Brush myBarBrush2 = new SolidBrush(PrintProtocol.barBrush2);
                    Brush myBarBrushWeight2 = new SolidBrush(PrintProtocol.barBrush3);
                    //统计各颜色水果的个数
                    UInt64[] colorFruitNumber2 = new UInt64[ConstPreDefine.MAX_COLOR_GRADE_NUM];
                    UInt64[] colorFruitWeight2 = new UInt64[ConstPreDefine.MAX_COLOR_GRADE_NUM];
                        ...
                        for (int j = 0; j < dataInterface.WeightOrSizeGradeSum; j++)
                        {
                            ...
                            switch (Convert.ToInt32(dataInterface.IoStStGradeInfo.grades[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j].nColorGrade))
                            {
                                case 0:
                                    ...
                                    colorFruitWeight2[0] += tempWeight;
                                    break;
                                case 1:
                                    colorFruitNumber2[1] += tempNum;
                                    colorFruitWeight2[1] += tempWeight;
                                    break;
                                case 2:
                                    colorFruitNumber2[2] += tempNum;
                                    colorFruitWeight2[2] += tempWeight;
                                    break;
                                case 3:
                                    colorFruitNumber2[3] += tempNum;
                                    colorFruitWeight2[3] += tempWeight;
                                    break;
                                case 4:
                                    colorFruitNumber2[4] += tempNum;
                                    colorFruitWeight2[4] += tempWeight;
                                    break;
                                case 5:
                                    colorFruitNumber2[5] += tempNum;
                                    colorFruitWeight2[5] += tempWeight;
                                    break;
                                case 6:
                                    colorFruitNumber2[6] += tempNum;
                                    colorFruitWeight2[6] += tempWeight;
                                    break;
                                case 7:
                                    colorFruitNumber2[7] += tempNum;
                                    colorFruitWeight2[7] += tempWeight;
                                    break;
                                case 8:
                                    colorFruitNumber2[8] += tempNum;
                                    colorFruitWeight2[8] += tempWeight;
                                    break;
                                case 9:
                                    colorFruitNumber2[9] += tempNum;
                                    colorFruitWeight2[9] += tempWeight;
                                    break;
                                case 10:
                                    colorFruitNumber2[10] += tempNum;
                                    colorFruitWeight2[10] += tempWeight;
                                    break;
                                case 11:
                                    colorFruitNumber2[11] += tempNum;
                                    colorFruitWeight2[11] += tempWeight;
                                    break;
                                case 12:
                                    colorFruitNumber2[12] += tempNum;
                                    colorFruitWeight2[12] += tempWeight;
                                    break;
                                case 13:
                                    colorFruitNumber2[13] += tempNum;
                                    colorFruitWeight2[13] += tempWeight;
                                    break;
                                case 14:
                                    colorFruitNumber2[14] += tempNum;
                                    colorFruitWeight2[14] += tempWeight;
                                    break;
                                case 15:
                                    colorFruitNumber2[15] += tempNum;
                                    colorFruitWeight2[15] += tempWeight;
                                    break;
                                default:
                                    break;
                            }
                    ...
                    #endregion
                    UInt64 uMaxValueNumber2 = FunctionInterface.GetMaxValue(colorFruitNumber2);
                    UInt64 uSumValueNumber2 = FunctionInterface.GetSumValue(colorFruitNumber2);
                    UInt64 uMaxValueWeight2 = FunctionInterface.GetMaxValue(colorFruitWeight2);
                    UInt64 uSumValueWeight2 = FunctionInterface.GetSumValue(colorFruitWeight2);
                    //界面设定
                    if ((colorGrade2.Length - 1) * (PrintProtocol.cylinderWidth1 * 2 + PrintProtocol.cylinderSpace1) + PrintProtocol.cylinderWidth1 * 2 + PrintProtocol.ModuleRightDistance < PrintProtocol.barImageWidht)
                    {
                        cylinderWidth = PrintProtocol.cylinderWidth1;
                        cylinderSpace = PrintProtocol.cylinderSpace1;
                        cylinderLeftMargin = (PrintProtocol.barImageWidht - (colorGrade2.Length - 1) * (PrintProtocol.cylinderWidth1 * 2 + PrintProtocol.cylinderSpace1) - PrintProtocol.cylinderWidth1 * 2 - PrintProtocol.ModuleRightDistance) / 2;
                        cylinderDigitLeftDistance = PrintProtocol.cylinderDigitLeftDistance1;
                    }
                    else
                    {
                        //cylinderWidth = PrintProtocol.cylinderWidth2;
                        //cylinderSpace = PrintProtocol.cylinderSpace2;
                        cylinderWidth = (PrintProtocol.barImageWidht - (colorGrade2.Length - 1) * 5 - PrintProtocol.ModuleRightDistance) / dataInterface.ExportSum / 2;
                        cylinderSpace = 5;
                        cylinderLeftMargin = (PrintProtocol.barImageWidht - (colorGrade2.Length - 1) * (cylinderWidth * 2 + cylinderSpace) - cylinderWidth * 2 - PrintProtocol.ModuleRightDistance) / 2;
                        cylinderDigitLeftDistance = PrintProtocol.cylinderDigitLeftDistance2;
                    }
                    //框 柱体1 柱体2 个数 重量(颜色框字样)
                    e.Graphics.DrawRectangle(new Pen(Color.Black), PrintProtocol.barImageWidht - PrintProtocol.ModuleRightDistance, PrintProtocol.barImageHeight / 2 - PrintProtocol.ModuleMiddleDistance,
                        PrintProtocol.ModuleFrameWidth, PrintProtocol.ModuleFrameHeight);
                    e.Graphics.FillRectangle(myBarBrush2,
                        PrintProtocol.barImageWidht - PrintProtocol.ModuleRightDistance + PrintProtocol.ModuleSmallGraphHorizontalSpace,
                        PrintProtocol.barImageHeight / 2 - PrintProtocol.ModuleMiddleDistance + PrintProtocol.ModuleSmallGraphVerticalSpace,
                        PrintProtocol.ModuleSmallCylinderWidth, PrintProtocol.ModuleSmallCylinderHeight);
                    e.Graphics.FillRectangle(myBarBrushWeight2,
                        PrintProtocol.barImageWidht - PrintProtocol.ModuleRightDistance + PrintProtocol.ModuleSmallGraphHorizontalSpace,
                        PrintProtocol.barImageHeight / 2 - PrintProtocol.ModuleMiddleDistance + PrintProtocol.ModuleSmallGraphVerticalSpace * 2 + PrintProtocol.ModuleSmallCylinderHeight,
                        PrintProtocol.ModuleSmallCylinderWidth, PrintProtocol.ModuleSmallCylinderHeight);
                    e.Graphics.DrawString(m_resourceManager.GetString("LblPieces.Text"), new Font(PrintProtocol.ModuleFontStyle, PrintProtocol.ModuleFontSize, FontStyle.Regular), myCurrentBrush2,
                        PrintProtocol.barImageWidht - PrintProtocol.ModuleRightDistance + PrintProtocol.ModuleSmallGraphHorizontalSpace + PrintProtocol.ModuleSmallCylinderWidth + PrintProtocol.ModuleFontHorizontalSpace,
                        PrintProtocol.barImageHeight / 2 - PrintProtocol.ModuleMiddleDistance + PrintProtocol.ModuleSmallGraphVerticalSpace + PrintProtocol.ModuleFontVerticalSpace);
                    e.Graphics.DrawString(m_resourceManager.GetString("LblWeight.Text"), new Font(PrintProtocol.ModuleFontStyle, PrintProtocol.ModuleFontSize, FontStyle.Regular), myCurrentBrush2,
                        PrintProtocol.barImageWidht - PrintProtocol.ModuleRightDistance + PrintProtocol.ModuleSmallGraphHorizontalSpace + PrintProtocol.ModuleSmallCylinderWidth + PrintProtocol.ModuleFontHorizontalSpace,
                        PrintProtocol.barImageHeight / 2 - PrintProtocol.ModuleMiddleDistance + PrintProtocol.ModuleSmallGraphVerticalSpace * 2 + PrintProtocol.ModuleFontVerticalSpace + PrintProtocol.ModuleSmallCylinderHeight);
                    for (int i = 0; i < colorGrade2.Length;i++ )
                    {
                        ...
                        {
                            //柱形图个数
                            e.Graphics.FillRectangle(myBarBrush2, cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace),
                                PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - PrintProtocol.cylinderMinHeight,
                                cylinderWidth, PrintProtocol.cylinderMinHeight);
                            //柱形图重量
                            e.Graphics.FillRectangle(myBarBrushWeight2, cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth,
                                PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - PrintProtocol.cylinderMinHeight,
                                cylinderWidth, PrintProtocol.cylinderMinHeight);
                        }
                        else
                        {
                            //柱形图个数
                            e.Graphics.FillRectangle(myBarBrush2, cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace),
                                PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)colorFruitNumber2[i] / uMaxValueNumber2)),
                                cylinderWidth, (int)(PrintProtocol.cylinderMaxHeight * ((double)colorFruitNumber2[i] / uMaxValueNumber2)));
                            //柱形图重量
                            e.Graphics.FillRectangle(myBarBrushWeight2, cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth,
                                PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)colorFruitWeight2[i] / uMaxValueWeight2)),
                                cylinderWidth, (int)(PrintProtocol.cylinderMaxHeight * ((double)colorFruitWeight2[i] / uMaxValueWeight2)));
                            //显示个数值
                            if ((int)(PrintProtocol.cylinderMaxHeight * ((double)colorFruitNumber2[i] / uMaxValueNumber2)) > PrintProtocol.cylinderStandardCylinderHeigh)
                            {
                                e.Graphics.TranslateTransform(cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderDigitLeftDistance,
                                    PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - cylinderDigitLeftDistance);
                                e.Graphics.RotateTransform(-90f);
                            ...
                            {
                                e.Graphics.TranslateTransform(cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderDigitLeftDistance,
                                    PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)colorFruitNumber2[i] / uMaxValueNumber2)) - PrintProtocol.cylinderDigitBottomDistance);
                                e.Graphics.RotateTransform(-90f);
                                e.Graphics.DrawString(colorFruitNumber2[i].ToString(),
                                    new Font("Times New Roman", 10, FontStyle.Bold), myCurrentBrush2, 0, 0);
                                e.Graphics.ResetTransform();
                            ...
                            //显示重量值
                            if ((int)(PrintProtocol.cylinderMaxHeight * ((double)colorFruitWeight2[i] / uMaxValueWeight2)) > PrintProtocol.cylinderStandardCylinderHeigh)
                            {
                                e.Graphics.TranslateTransform(cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth + cylinderDigitLeftDistance,
                                    PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - cylinderDigitLeftDistance);
                                e.Graphics.RotateTransform(-90f);
                                e.Graphics.DrawString(colorFruitWeight2[i].ToString(),
                                    new Font("Times New Roman", 10, FontStyle.Bold), myCurrentBrush2, 0, 0);
                                e.Graphics.ResetTransform();
                                e.Graphics.TranslateTransform(PrintProtocol.leftMargin, currentAvailableHeight);
                            }
                            ...
                            {
                                e.Graphics.TranslateTransform(cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth + cylinderDigitLeftDistance,
                                    PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)colorFruitWeight2[i] / uMaxValueWeight2)) - PrintProtocol.cylinderDigitBottomDistance);
                                e.Graphics.RotateTransform(-90f);
                                e.Graphics.DrawString(colorFruitWeight2[i].ToString(),
                                    new Font("Times New Roman", 10, FontStyle.Bold), myCurrentBrush2, 0, 0);
                                e.Graphics.ResetTransform();
                        ...
                        {
                            //个数百分比
                            e.Graphics.DrawString(((double)colorFruitNumber2[i] / uSumValueNumber2).ToString("0.00%"),
                                new Font("Times New Roman", 10, FontStyle.Regular), myCurrentBrush2,
                                cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + PrintProtocol.cylinderPrecentLeftDistance,
                                PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)colorFruitNumber2[i] / uMaxValueNumber2)) - PrintProtocol.cylinderPrecentBottomDistance);
                            //重量百分比
                            e.Graphics.DrawString(((double)colorFruitWeight2[i] / uSumValueWeight2).ToString("0.00%"),
                                new Font("Times New Roman", 10, FontStyle.Regular), myCurrentBrush2,
                                cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth + PrintProtocol.cylinderPrecentLeftDistance,
                                PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)colorFruitWeight2[i] / uMaxValueWeight2)) - PrintProtocol.cylinderPrecentBottomDistance);
                        }
                ...
                case 3:
                    ...
                    string barHead3 = m_resourceManager.GetString("LblPrintNOrWPercenet.Text");
                    ...
                    Brush myBarBrush3 = new SolidBrush(PrintProtocol.barBrush2);
                    Brush myBarBrushWeight3 = new SolidBrush(PrintProtocol.barBrush3);
                    //统计各形状水果的个数
                    UInt64[] shapeFruitNumber3 = new UInt64[ConstPreDefine.MAX_SHAPE_GRADE_NUM];
                    UInt64[] shapeFruitWeight3 = new UInt64[ConstPreDefine.MAX_SHAPE_GRADE_NUM];
                        ...
                        for (int j = 0; j < dataInterface.WeightOrSizeGradeSum; j++)
                        {
                            ...
                            switch (Convert.ToInt32(dataInterface.IoStStGradeInfo.grades[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j].sbShapeSize))
                            {
                                case 0:
                                    ...
                                    shapeFruitWeight3[0] += tempWeight;
                                    break;
                                case 1:
                    ...
                    #endregion
                    UInt64 uMaxValueNumber3 = FunctionInterface.GetMaxValue(shapeFruitNumber3);
                    UInt64 uSumValueNumber3 = FunctionInterface.GetSumValue(shapeFruitNumber3);
                    UInt64 uMaxValueWeight3 = FunctionInterface.GetMaxValue(shapeFruitWeight3);
                    UInt64 uSumValueWeight3 = FunctionInterface.GetSumValue(shapeFruitWeight3);
                    //界面设定
                    if ((shapeGrade3.Length - 1) * (PrintProtocol.cylinderWidth1 * 2 + PrintProtocol.cylinderSpace1) + PrintProtocol.cylinderWidth1 * 2 + PrintProtocol.ModuleRightDistance < PrintProtocol.barImageWidht)
                    {
                        cylinderWidth = PrintProtocol.cylinderWidth1;
                        cylinderSpace = PrintProtocol.cylinderSpace1;
                        cylinderLeftMargin = (PrintProtocol.barImageWidht - (shapeGrade3.Length - 1) * (PrintProtocol.cylinderWidth1 * 2 + PrintProtocol.cylinderSpace1) - PrintProtocol.cylinderWidth1 * 2 - PrintProtocol.ModuleRightDistance) / 2;
                        cylinderDigitLeftDistance = PrintProtocol.cylinderDigitLeftDistance1;
                    }
                    else
                    {
                        //cylinderWidth = PrintProtocol.cylinderWidth2;
                        //cylinderSpace = PrintProtocol.cylinderSpace2;
                        cylinderWidth = (PrintProtocol.barImageWidht - (shapeGrade3.Length - 1) * 5 - PrintProtocol.ModuleRightDistance) / dataInterface.ExportSum / 2;
                        cylinderSpace = 5;
                        cylinderLeftMargin = (PrintProtocol.barImageWidht - (shapeGrade3.Length - 1) * (cylinderWidth * 2 + cylinderSpace) - cylinderWidth * 2 - PrintProtocol.ModuleRightDistance) / 2;
                        cylinderDigitLeftDistance = PrintProtocol.cylinderDigitLeftDistance2;
                    }
                    //框 柱体1 柱体2 个数 重量(颜色框字样)
                    e.Graphics.DrawRectangle(new Pen(Color.Black), PrintProtocol.barImageWidht - PrintProtocol.ModuleRightDistance, PrintProtocol.barImageHeight / 2 - PrintProtocol.ModuleMiddleDistance,
                        PrintProtocol.ModuleFrameWidth, PrintProtocol.ModuleFrameHeight);
                    e.Graphics.FillRectangle(myBarBrush3,
                        PrintProtocol.barImageWidht - PrintProtocol.ModuleRightDistance + PrintProtocol.ModuleSmallGraphHorizontalSpace,
                        PrintProtocol.barImageHeight / 2 - PrintProtocol.ModuleMiddleDistance + PrintProtocol.ModuleSmallGraphVerticalSpace,
                        PrintProtocol.ModuleSmallCylinderWidth, PrintProtocol.ModuleSmallCylinderHeight);
                    e.Graphics.FillRectangle(myBarBrushWeight3,
                        PrintProtocol.barImageWidht - PrintProtocol.ModuleRightDistance + PrintProtocol.ModuleSmallGraphHorizontalSpace,
                        PrintProtocol.barImageHeight / 2 - PrintProtocol.ModuleMiddleDistance + PrintProtocol.ModuleSmallGraphVerticalSpace * 2 + PrintProtocol.ModuleSmallCylinderHeight,
                        PrintProtocol.ModuleSmallCylinderWidth, PrintProtocol.ModuleSmallCylinderHeight);
                    e.Graphics.DrawString(m_resourceManager.GetString("LblPieces.Text"), new Font(PrintProtocol.ModuleFontStyle, PrintProtocol.ModuleFontSize, FontStyle.Regular), myCurrentBrush3,
                        PrintProtocol.barImageWidht - PrintProtocol.ModuleRightDistance + PrintProtocol.ModuleSmallGraphHorizontalSpace + PrintProtocol.ModuleSmallCylinderWidth + PrintProtocol.ModuleFontHorizontalSpace,
                        PrintProtocol.barImageHeight / 2 - PrintProtocol.ModuleMiddleDistance + PrintProtocol.ModuleSmallGraphVerticalSpace + PrintProtocol.ModuleFontVerticalSpace);
                    e.Graphics.DrawString(m_resourceManager.GetString("LblWeight.Text"), new Font(PrintProtocol.ModuleFontStyle, PrintProtocol.ModuleFontSize, FontStyle.Regular), myCurrentBrush3,
                        PrintProtocol.barImageWidht - PrintProtocol.ModuleRightDistance + PrintProtocol.ModuleSmallGraphHorizontalSpace + PrintProtocol.ModuleSmallCylinderWidth + PrintProtocol.ModuleFontHorizontalSpace,
                        PrintProtocol.barImageHeight / 2 - PrintProtocol.ModuleMiddleDistance + PrintProtocol.ModuleSmallGraphVerticalSpace * 2 + PrintProtocol.ModuleFontVerticalSpace + PrintProtocol.ModuleSmallCylinderHeight);
                    for (int i = 0; i < shapeGrade3.Length; i++)
                    {
                        ...
                        {
                            //柱形图个数
                            e.Graphics.FillRectangle(myBarBrush3, cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace),
                                PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - PrintProtocol.cylinderMinHeight,
                                cylinderWidth, PrintProtocol.cylinderMinHeight);
                            //柱形图重量
                            e.Graphics.FillRectangle(myBarBrushWeight3, cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth,
                                PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - PrintProtocol.cylinderMinHeight,
                                cylinderWidth, PrintProtocol.cylinderMinHeight);
                        }
                        else
                        {
                            //柱形图个数
                            e.Graphics.FillRectangle(myBarBrush3, cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace),
                                PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)shapeFruitNumber3[i] / uMaxValueNumber3)),
                                cylinderWidth, (int)(PrintProtocol.cylinderMaxHeight * ((double)shapeFruitNumber3[i] / uMaxValueNumber3)));
                            //柱形图重量
                            e.Graphics.FillRectangle(myBarBrushWeight3, cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth,
                                PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)shapeFruitWeight3[i] / uMaxValueWeight3)),
                                cylinderWidth, (int)(PrintProtocol.cylinderMaxHeight * ((double)shapeFruitWeight3[i] / uMaxValueWeight3)));
                            //显示个数值
                            if ((int)(PrintProtocol.cylinderMaxHeight * ((double)shapeFruitNumber3[i] / uMaxValueNumber3)) > PrintProtocol.cylinderStandardCylinderHeigh)
                            {
                                e.Graphics.TranslateTransform(cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderDigitLeftDistance,
                                    PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - cylinderDigitLeftDistance);
                                e.Graphics.RotateTransform(-90f);
                            ...
                            {
                                e.Graphics.TranslateTransform(cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderDigitLeftDistance,
                                    PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)shapeFruitNumber3[i] / uMaxValueNumber3)) - PrintProtocol.cylinderDigitBottomDistance);
                                e.Graphics.RotateTransform(-90f);
                                e.Graphics.DrawString(shapeFruitNumber3[i].ToString(),
                                    new Font("Times New Roman", 10, FontStyle.Bold), myCurrentBrush3, 0, 0);
                                e.Graphics.ResetTransform();
                            ...
                            //显示重量值
                            if ((int)(PrintProtocol.cylinderMaxHeight * ((double)shapeFruitWeight3[i] / uMaxValueWeight3)) > PrintProtocol.cylinderStandardCylinderHeigh)
                            {
                                e.Graphics.TranslateTransform(cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth + cylinderDigitLeftDistance,
                                    PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - cylinderDigitLeftDistance);
                                e.Graphics.RotateTransform(-90f);
                                e.Graphics.DrawString(shapeFruitWeight3[i].ToString(),
                                    new Font("Times New Roman", 10, FontStyle.Bold), myCurrentBrush3, 0, 0);
                                e.Graphics.ResetTransform();
                                e.Graphics.TranslateTransform(PrintProtocol.leftMargin, currentAvailableHeight);
                            }
                            ...
                            {
                                e.Graphics.TranslateTransform(cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth + cylinderDigitLeftDistance,
                                    PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)shapeFruitWeight3[i] / uMaxValueWeight3)) - PrintProtocol.cylinderDigitBottomDistance);
                                e.Graphics.RotateTransform(-90f);
                                e.Graphics.DrawString(shapeFruitWeight3[i].ToString(),
                                    new Font("Times New Roman", 10, FontStyle.Bold), myCurrentBrush3, 0, 0);
                                e.Graphics.ResetTransform();
                        ...
                        {
                            //个数百分比
                            e.Graphics.DrawString(((double)shapeFruitNumber3[i] / uSumValueNumber3).ToString("0.00%"),
                                new Font("Times New Roman", 10, FontStyle.Regular), myCurrentBrush3,
                                cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + PrintProtocol.cylinderPrecentLeftDistance,
                                PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)shapeFruitNumber3[i] / uMaxValueNumber3)) - PrintProtocol.cylinderPrecentBottomDistance);
                            //重量百分比
                            e.Graphics.DrawString(((double)shapeFruitWeight3[i] / uSumValueWeight3).ToString("0.00%"),
                                new Font("Times New Roman", 10, FontStyle.Regular), myCurrentBrush3,
                                cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth + PrintProtocol.cylinderPrecentLeftDistance,
                                PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)shapeFruitWeight3[i] / uMaxValueWeight3)) - PrintProtocol.cylinderPrecentBottomDistance);
                        }
                    }
                    e.Graphics.ResetTransform();
                    //try
                ...
                case 4:
                    ...
                    string barHead4 = m_resourceManager.GetString("LblPrintNOrWPercenet.Text");
                    ...
                    Brush myBarBrush4 = new SolidBrush(PrintProtocol.barBrush2);
                    Brush myBarBrushWeight4 = new SolidBrush(PrintProtocol.barBrush3);
                    //界面设定
                    if ((dataInterface.QualityGradeSum*dataInterface.WeightOrSizeGradeSum - 1) * (PrintProtocol.cylinderWidth1 * 2 + PrintProtocol.cylinderSpace1) + PrintProtocol.cylinderWidth1 * 2 + PrintProtocol.ModuleRightDistance < PrintProtocol.barImageWidht)
                    {
                        cylinderWidth = PrintProtocol.cylinderWidth1;
                        cylinderSpace = PrintProtocol.cylinderSpace1;
                        cylinderLeftMargin = (PrintProtocol.barImageWidht - (dataInterface.QualityGradeSum * dataInterface.WeightOrSizeGradeSum - 1) * (PrintProtocol.cylinderWidth1 * 2 + PrintProtocol.cylinderSpace1) - PrintProtocol.cylinderWidth1 * 2 - PrintProtocol.ModuleRightDistance) / 2;
                        cylinderDigitLeftDistance = PrintProtocol.cylinderDigitLeftDistance1;
                    }
                    else
                    {
                        //cylinderWidth = PrintProtocol.cylinderWidth2;
                        //cylinderSpace = PrintProtocol.cylinderSpace2;
                        cylinderWidth = (PrintProtocol.barImageWidht - (dataInterface.QualityGradeSum * dataInterface.WeightOrSizeGradeSum - 1) * 5 - PrintProtocol.ModuleRightDistance) / dataInterface.ExportSum / 2;
                        cylinderSpace = 5;
                        cylinderLeftMargin = (PrintProtocol.barImageWidht - (dataInterface.QualityGradeSum * dataInterface.WeightOrSizeGradeSum - 1) * (cylinderWidth * 2 + cylinderSpace) - cylinderWidth * 2 - PrintProtocol.ModuleRightDistance) / 2;
                        cylinderDigitLeftDistance = PrintProtocol.cylinderDigitLeftDistance2;
                    }
                    //框 柱体1 柱体2 个数 重量(颜色框字样)
                    e.Graphics.DrawRectangle(new Pen(Color.Black), PrintProtocol.barImageWidht - PrintProtocol.ModuleRightDistance, PrintProtocol.barImageHeight / 2 - PrintProtocol.ModuleMiddleDistance,
                        PrintProtocol.ModuleFrameWidth, PrintProtocol.ModuleFrameHeight);
                    e.Graphics.FillRectangle(myBarBrush4,
                        PrintProtocol.barImageWidht - PrintProtocol.ModuleRightDistance + PrintProtocol.ModuleSmallGraphHorizontalSpace,
                        PrintProtocol.barImageHeight / 2 - PrintProtocol.ModuleMiddleDistance + PrintProtocol.ModuleSmallGraphVerticalSpace,
                        PrintProtocol.ModuleSmallCylinderWidth, PrintProtocol.ModuleSmallCylinderHeight);
                    e.Graphics.FillRectangle(myBarBrushWeight4,
                        PrintProtocol.barImageWidht - PrintProtocol.ModuleRightDistance + PrintProtocol.ModuleSmallGraphHorizontalSpace,
                        PrintProtocol.barImageHeight / 2 - PrintProtocol.ModuleMiddleDistance + PrintProtocol.ModuleSmallGraphVerticalSpace * 2 + PrintProtocol.ModuleSmallCylinderHeight,
                        PrintProtocol.ModuleSmallCylinderWidth, PrintProtocol.ModuleSmallCylinderHeight);
                    e.Graphics.DrawString(m_resourceManager.GetString("LblPieces.Text"), new Font(PrintProtocol.ModuleFontStyle, PrintProtocol.ModuleFontSize, FontStyle.Regular), myCurrentBrush4,
                        PrintProtocol.barImageWidht - PrintProtocol.ModuleRightDistance + PrintProtocol.ModuleSmallGraphHorizontalSpace + PrintProtocol.ModuleSmallCylinderWidth + PrintProtocol.ModuleFontHorizontalSpace,
                        PrintProtocol.barImageHeight / 2 - PrintProtocol.ModuleMiddleDistance + PrintProtocol.ModuleSmallGraphVerticalSpace + PrintProtocol.ModuleFontVerticalSpace);
                    e.Graphics.DrawString(m_resourceManager.GetString("LblWeight.Text"), new Font(PrintProtocol.ModuleFontStyle, PrintProtocol.ModuleFontSize, FontStyle.Regular), myCurrentBrush4,
                        PrintProtocol.barImageWidht - PrintProtocol.ModuleRightDistance + PrintProtocol.ModuleSmallGraphHorizontalSpace + PrintProtocol.ModuleSmallCylinderWidth + PrintProtocol.ModuleFontHorizontalSpace,
                        PrintProtocol.barImageHeight / 2 - PrintProtocol.ModuleMiddleDistance + PrintProtocol.ModuleSmallGraphVerticalSpace * 2 + PrintProtocol.ModuleFontVerticalSpace + PrintProtocol.ModuleSmallCylinderHeight);
                    UInt64 uMaxValueNumber4 = FunctionInterface.GetMaxValue(dataInterface.IoStStatistics.nGradeCount);
                    UInt64 uSumValueNumber4 = FunctionInterface.GetSumValue(dataInterface.IoStStatistics.nGradeCount);
                    UInt64 uMaxValueWeight4 = FunctionInterface.GetMaxValue(dataInterface.IoStStatistics.nWeightGradeCount);
                    UInt64 uSumValueWeight4 = FunctionInterface.GetSumValue(dataInterface.IoStStatistics.nWeightGradeCount);
                    string strSizeName4;     //尺寸名称
                    string strQualityName4;   //品质名称
                    string strMixName4;       //总名称：尺寸名称.品质名称
                    for (int i = 0; i < dataInterface.QualityGradeSum; i++)
                    {
                        for (int j = 0; j < dataInterface.WeightOrSizeGradeSum; j++)
                        {
                            //柱形图下标字样
                            strSizeName4 = Encoding.Default.GetString(dataInterface.IoStStGradeInfo.strSizeGradeName, j * ConstPreDefine.MAX_TEXT_LENGTH, ConstPreDefine.MAX_TEXT_LENGTH);
                            strQualityName4 = Encoding.Default.GetString(dataInterface.IoStStGradeInfo.strQualityGradeName, i * ConstPreDefine.MAX_TEXT_LENGTH, ConstPreDefine.MAX_TEXT_LENGTH);
                            strMixName4 = strSizeName4.Substring(0, strSizeName4.IndexOf("\0")) + "." + strQualityName4.Substring(0, strQualityName4.IndexOf("\0"));
                            e.Graphics.DrawString(strMixName4,
                                new Font("Times New Roman", 10, FontStyle.Regular), myCurrentBrush4,
                                cylinderLeftMargin + (i * dataInterface.WeightOrSizeGradeSum + j) * (cylinderWidth*2 + cylinderSpace),
                                PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin + PrintProtocol.cylinderOrTextNote);
                            if (dataInterface.IoStStatistics.nGradeCount[i*ConstPreDefine.MAX_SIZE_GRADE_NUM+j] == 0)
                            {
                                //柱形图个数
                                e.Graphics.FillRectangle(myBarBrush4, cylinderLeftMargin + (i * dataInterface.WeightOrSizeGradeSum + j) * (cylinderWidth * 2 + cylinderSpace),
                                    PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - PrintProtocol.cylinderMinHeight,
                                    cylinderWidth, PrintProtocol.cylinderMinHeight);
                                //柱形图重量
                                e.Graphics.FillRectangle(myBarBrushWeight4, cylinderLeftMargin + (i * dataInterface.WeightOrSizeGradeSum + j) * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth,
                                    PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - PrintProtocol.cylinderMinHeight,
                                    cylinderWidth, PrintProtocol.cylinderMinHeight);
                            }
                            else
                            {
                                //柱形图个数
                                e.Graphics.FillRectangle(myBarBrush4, cylinderLeftMargin + (i * dataInterface.WeightOrSizeGradeSum + j) * (cylinderWidth * 2 + cylinderSpace),
                                    PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)dataInterface.IoStStatistics.nGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j] / uMaxValueNumber4)),
                                    cylinderWidth, (int)(PrintProtocol.cylinderMaxHeight * ((double)dataInterface.IoStStatistics.nGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j] / uMaxValueNumber4)));
                                //柱形图重量
                                e.Graphics.FillRectangle(myBarBrushWeight4, cylinderLeftMargin + (i * dataInterface.WeightOrSizeGradeSum + j) * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth,
                                    PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)dataInterface.IoStStatistics.nWeightGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j] / uMaxValueWeight4)),
                                    cylinderWidth, (int)(PrintProtocol.cylinderMaxHeight * ((double)dataInterface.IoStStatistics.nWeightGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j] / uMaxValueWeight4)));
                                //显示个数值
                                if ((int)(PrintProtocol.cylinderMaxHeight * ((double)dataInterface.IoStStatistics.nGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j] / uMaxValueNumber4)) > PrintProtocol.cylinderStandardCylinderHeigh)
                                {
                                    e.Graphics.TranslateTransform(cylinderLeftMargin + (i * dataInterface.WeightOrSizeGradeSum + j) * (cylinderWidth * 2 + cylinderSpace) + cylinderDigitLeftDistance,
                                        PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - cylinderDigitLeftDistance);
                                    e.Graphics.RotateTransform(-90f);
                                    e.Graphics.DrawString(dataInterface.IoStStatistics.nGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j].ToString(),
                                ...
                                {
                                    e.Graphics.TranslateTransform(cylinderLeftMargin + (i * dataInterface.WeightOrSizeGradeSum + j) * (cylinderWidth * 2 + cylinderSpace) + cylinderDigitLeftDistance,
                                        PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)dataInterface.IoStStatistics.nGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j] / uMaxValueNumber4)) - PrintProtocol.cylinderDigitBottomDistance);
                                    e.Graphics.RotateTransform(-90f);
                                    e.Graphics.DrawString(dataInterface.IoStStatistics.nGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j].ToString(),
                                        new Font("Times New Roman", 10, FontStyle.Bold), myCurrentBrush4, 0, 0);
                                    e.Graphics.ResetTransform();
                                ...
                                //显示重量值
                                if ((int)(PrintProtocol.cylinderMaxHeight * ((double)dataInterface.IoStStatistics.nWeightGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j] / uMaxValueWeight4)) > PrintProtocol.cylinderStandardCylinderHeigh)
                                {
                                    e.Graphics.TranslateTransform(cylinderLeftMargin + (i * dataInterface.WeightOrSizeGradeSum + j) * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth + cylinderDigitLeftDistance,
                                        PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - cylinderDigitLeftDistance);
                                    e.Graphics.RotateTransform(-90f);
                                    e.Graphics.DrawString(dataInterface.IoStStatistics.nWeightGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j].ToString(),
                                        new Font("Times New Roman", 10, FontStyle.Bold), myCurrentBrush4, 0, 0);
                                    e.Graphics.ResetTransform();
                                    e.Graphics.TranslateTransform(PrintProtocol.leftMargin, currentAvailableHeight);
                                }
                                ...
                                {
                                    e.Graphics.TranslateTransform(cylinderLeftMargin + (i * dataInterface.WeightOrSizeGradeSum + j) * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth + cylinderDigitLeftDistance,
                                        PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)dataInterface.IoStStatistics.nWeightGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j] / uMaxValueWeight4)) - PrintProtocol.cylinderDigitBottomDistance);
                                    e.Graphics.RotateTransform(-90f);
                                    e.Graphics.DrawString(dataInterface.IoStStatistics.nWeightGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j].ToString(),
                                        new Font("Times New Roman", 10, FontStyle.Bold), myCurrentBrush4, 0, 0);
                                    e.Graphics.ResetTransform();
                            ...
                            if (uSumValueNumber4 == 0)
                            {
                                //个数百分比
                                e.Graphics.DrawString("0.00%", new Font("Times New Roman", 10, FontStyle.Regular), myCurrentBrush4,
                                    cylinderLeftMargin + (i * dataInterface.WeightOrSizeGradeSum + j) * (cylinderWidth * 2 + cylinderSpace) + PrintProtocol.cylinderPrecentLeftDistance,
                                    PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - PrintProtocol.cylinderMinHeight - PrintProtocol.cylinderPrecentBottomDistance);
                                //重量百分比
                                e.Graphics.DrawString("0.00%", new Font("Times New Roman", 10, FontStyle.Regular), myCurrentBrush4,
                                    cylinderLeftMargin + (i * dataInterface.WeightOrSizeGradeSum + j) * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth + PrintProtocol.cylinderPrecentLeftDistance,
                                    PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - PrintProtocol.cylinderMinHeight - PrintProtocol.cylinderPrecentBottomDistance);
                            }
                            else
                            {
                                //个数百分比
                                e.Graphics.DrawString(((double)dataInterface.IoStStatistics.nGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j] / uSumValueNumber4).ToString("0.00%"),
                                    new Font("Times New Roman", 10, FontStyle.Regular), myCurrentBrush4,
                                    cylinderLeftMargin + (i * dataInterface.WeightOrSizeGradeSum + j) * (cylinderWidth * 2 + cylinderSpace) + PrintProtocol.cylinderPrecentLeftDistance,
                                    PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)dataInterface.IoStStatistics.nGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j] / uMaxValueNumber4)) - PrintProtocol.cylinderPrecentBottomDistance);
                                //重量百分比
                                e.Graphics.DrawString(((double)dataInterface.IoStStatistics.nWeightGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j] / uSumValueWeight4).ToString("0.00%"),
                                    new Font("Times New Roman", 10, FontStyle.Regular), myCurrentBrush4,
                                    cylinderLeftMargin + (i * dataInterface.WeightOrSizeGradeSum + j) * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth + PrintProtocol.cylinderPrecentLeftDistance,
                                    PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)dataInterface.IoStStatistics.nWeightGradeCount[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j] / uMaxValueWeight4)) - PrintProtocol.cylinderPrecentBottomDistance);
                            }
                        }
                    }
                    e.Graphics.ResetTransform();
                    ...
                    string barTitle4 = m_resourceManager.GetString("tabPage5.Text");
                ...
                //    break;
                #endregion
                case 5: //6->5 Modify by ChengSk - 20180726 
                    #region 打印      重量统计表
                    #region 
                    ...
                    SumBoxValue60 = FunctionInterface.GetSumValue(dataInterface.IoStStatistics.nBoxGradeCount);//获取总箱数
                        ...
                        if (currentPageIndex == 1)            //第一页
                        {
                            ...
                            string tablesFirstItems1 = m_resourceManager.GetString("LblMainReportWeight.Text");
                        ...
                        for (int i = 1; i < dataInterface.WeightOrSizeGradeSum + 1; i++)
                        {
                            ...
                            for (int j = 1; j < dataInterface.QualityGradeSum + 1; j++)
                            {
                                ...
                                if (((i - 1) /** dataInterface.QualityGradeSum*/ + j) == PrintProtocol.GradeNum1)
                                {
                                    Isbreak = true;
                                    break;
                                }
                        ...
                        if (intPage1 == 1)
                            ...
                            string currentPages60 = m_resourceManager.GetString("LblPrintPages.Text") + " " + currentPageIndex.ToString() + "/" + intPage1.ToString();
                        ...
                        else if (currentPageIndex == intPage1) //最后一页
                        {
                            #region 打印最后一页
                                ...
                                //int heightIndex = 1;//打印表格数据 add by xcw 20201103
                                for (int i = 1; i < dataInterface.WeightOrSizeGradeSum + 1; i++)
                                {
                                    ulong tablesMiddleItems2 = 0;
                                    double tablesMiddleItems3 = 0.0;
                        ...
                        else  //中间页
                        {
                            #region 打印中间页
                                ...
                                int heightIndex = 1;
                                 for (int i = 1; i < dataInterface.WeightOrSizeGradeSum + 1; i++)
                                 {
                                     ...
                                     e.Graphics.DrawString(tablesMiddleItems0, sumTableFont63, sumTableBrush63,
                                         (sumTalbeWidth - XMaxSize63.Width) / 2 + PrintProtocol.leftMargin + 0 * sumTalbeWidth,
                                         currentAvailableHeight + ((i + 1)) * sumTableHeight - XMaxSize63.Height - PrintProtocol.tableBottomMargin);
                                     string tablesMiddleItems1 = dataInterface.IoStStGradeInfo.grades[(i - 1)].nMinSize.ToString();
                                     ...
                                     e.Graphics.DrawString(tablesMiddleItems1, sumTableFont63, sumTableBrush63,
                                         (sumTalbeWidth - XMaxSize63.Width) / 2 + PrintProtocol.leftMargin + 1 * sumTalbeWidth,
                                         currentAvailableHeight + ((i + 1)) * sumTableHeight - XMaxSize63.Height - PrintProtocol.tableBottomMargin);
                                     XMaxSize63 = TitG63.MeasureString(tablesMiddleItems2.ToString(), sumTableFont63);
                                     e.Graphics.DrawString(tablesMiddleItems2.ToString(), sumTableFont63, sumTableBrush63,
                                         (sumTalbeWidth - XMaxSize63.Width) / 2 + PrintProtocol.leftMargin + 2 * sumTalbeWidth,
                                         currentAvailableHeight + ((i + 1)) * sumTableHeight - XMaxSize63.Height - PrintProtocol.tableBottomMargin);
                                     XMaxSize63 = TitG63.MeasureString(tablesMiddleItems3.ToString("0.000%"), sumTableFont63);
                                     e.Graphics.DrawString(tablesMiddleItems3.ToString("0.000%"), sumTableFont63, sumTableBrush63,
                                         (sumTalbeWidth - XMaxSize63.Width) / 2 + PrintProtocol.leftMargin + 3 * sumTalbeWidth,
                                         currentAvailableHeight + ((i + 1)) * sumTableHeight - XMaxSize63.Height - PrintProtocol.tableBottomMargin);
                                     XMaxSize63 = TitG63.MeasureString(tablesMiddleItems4.ToString("0.0"), sumTableFont63);
                                     e.Graphics.DrawString(tablesMiddleItems4.ToString("0.0"), sumTableFont63, sumTableBrush63,
                                         (sumTalbeWidth - XMaxSize63.Width) / 2 + PrintProtocol.leftMargin + 4 * sumTalbeWidth,
                                         currentAvailableHeight + ((i + 1)) * sumTableHeight - XMaxSize63.Height - PrintProtocol.tableBottomMargin);
                                     XMaxSize63 = TitG63.MeasureString(tablesMiddleItems5.ToString("0.000%"), sumTableFont63);
                                     e.Graphics.DrawString(tablesMiddleItems5.ToString("0.000%"), sumTableFont63, sumTableBrush63,
                                         (sumTalbeWidth - XMaxSize63.Width) / 2 + PrintProtocol.leftMargin + 5 * sumTalbeWidth,
                                         currentAvailableHeight + ((i + 1)) * sumTableHeight - XMaxSize63.Height - PrintProtocol.tableBottomMargin);
                                     XMaxSize63 = TitG63.MeasureString(tablesMiddleItems6.ToString(), sumTableFont63);
                                     e.Graphics.DrawString(tablesMiddleItems6.ToString(), sumTableFont63, sumTableBrush63,
                                         (sumTalbeWidth - XMaxSize63.Width) / 2 + PrintProtocol.leftMargin + 6 * sumTalbeWidth,
                                         currentAvailableHeight + ((i + 1)) * sumTableHeight - XMaxSize63.Height - PrintProtocol.tableBottomMargin);
                                 
                                     XMaxSize63 = TitG63.MeasureString(tablesMiddleItems7.ToString("0.000%"), sumTableFont63);
                                     e.Graphics.DrawString(tablesMiddleItems7.ToString("0.000%"), sumTableFont63, sumTableBrush63,
                                         (sumTalbeWidth - XMaxSize63.Width) / 2 + PrintProtocol.leftMargin + 7 * sumTalbeWidth,
                                         currentAvailableHeight + ((i + 1)) * sumTableHeight - XMaxSize63.Height - PrintProtocol.tableBottomMargin);
                                ...
                                string currentPages63 = m_resourceManager.GetString("LblPrintPages.Text") + " " + currentPageIndex.ToString() + "/" + intPage1.ToString();
                ...
                case 6: //6->5 Modify by ChengSk - 20180726 
                    ...
                    if (currentPageIndex == 1)            //第一页
                    {
                        ...
                        for (int j = 1; j < dataInterface.QualityGradeSum + 1; j++)
                        {
                            for (int i = 1; i < dataInterface.WeightOrSizeGradeSum + 1; i++) //中间dataInterface.WeightOrSizeGradeSum行
                            {
                                ...
                                string tablesMiddleItems6 = dataInterface.IoStStatistics.nBoxGradeCount[(j - 1) * ConstPreDefine.MAX_SIZE_GRADE_NUM + (i - 1)].ToString();//Modify by ChengSk - 20181126
                    ...
                    else  //中间页
                    {
                        ...
                        Font currentPagesFont63 = new Font("宋体", 12, FontStyle.Regular);
                        Brush currentPagesBrush63 = Brushes.Black;
                        string currentPages63 = m_resourceManager.GetString("LblPrintPages.Text") + " " + currentPageIndex.ToString() + "/" + intPage.ToString();
                        XMaxSize63 = TitG63.MeasureString(currentPages63, currentPagesFont63);
                        e.Graphics.DrawString(//使用DrawString方法绘制页数字符串
                            currentPages63, currentPagesFont63, currentPagesBrush63, (e.PageBounds.Width - PrintProtocol.leftMargin - PrintProtocol.rightMargin - XMaxSize63.Width) / 2 + PrintProtocol.leftMargin,
                            currentAvailableHeight);
        ...
        private void ExportExcelbutton_Click(object sender, EventArgs e)
        {
            ...
            if (dlg.ShowDialog() == DialogResult.OK)
            {
                ...
                if (File.Exists)
                {
                    ...
                    DialogResult result = MessageBox.Show("0x30001021 " + LanguageContainer.StatisticsInfoForm4Messagebox1Text[GlobalDataInterface.selectLanguageIndex],
                        LanguageContainer.StatisticsInfoForm4MessageboxInformationCaption[GlobalDataInterface.selectLanguageIndex], 
                ...
                //ExcelReportFunc.CreateExcel(dlg.FileName, dataInterface,true,false);
                string[] resource = { DateTime.Now.ToString(m_resourceManager.GetString("LblPrintDateTime.Text")),m_resourceManager.GetString("LblPrintBatchReport.Text"),m_resourceManager.GetString("LblPrintCustomerName.Text"),
                                     ...
                                     m_resourceManager.GetString("LblMainReportWeight.Text"),m_resourceManager.GetString("LblMainReportPieces.Text"), m_resourceManager.GetString("LblMainReportPiecesPer.Text"),
                ...
                {
                    ExcelReportFunc.CreateExcel(dlg.FileName, dataInterface, resource, false, false);
                }
                else
                {
                    ExcelReportFunc.CreateExcel(dlg.FileName, dataInterface, resource, true, false);
                }
               
                //MessageBox.Show("Export excel report successfully!");
                MessageBox.Show(LanguageContainer.StatisticsInfoForm4Messagebox2Text[GlobalDataInterface.selectLanguageIndex],
                                LanguageContainer.StatisticsInfoForm4MessageboxInformationCaption[GlobalDataInterface.selectLanguageIndex],
                                MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        private void StatisticsInfoForm4_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                GlobalDataInterface.UpdateDataInterfaceEvent -= new GlobalDataInterface.DataInterfaceEventHandler(OnUpdateDataInterfaceEvent);
            ...
            {
#if REALEASE
                GlobalDataInterface.WriteErrorInfo("StatisticsInfoForm4_FormClosing出错: " + ex.StackTrace);
#endif
            }
        }
