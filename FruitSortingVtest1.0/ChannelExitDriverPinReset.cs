...
{
    public partial class ChannelExitDriverPinReset : Form
    {
        public ChannelExitDriverPinReset()
        {
            InitializeComponent();
        }
        ...
        private void OKbutton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (this.PasswordtextBox.Text == "ReemoonReset")
                    {
                        //GlobalDataInterface.ChannelDriverReset = true;
