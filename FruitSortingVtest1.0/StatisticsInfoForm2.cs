...
{
    public partial class StatisticsInfoForm2 : Form
    {
        private DataInterface dataInterface;
        private Boolean bIsSourceDB;
        private ResourceManager m_resourceManager = new ResourceManager(typeof(StatisticsInfoForm2));//创建Mainform资源管理
        ...
        public StatisticsInfoForm2()
        {
            InitializeComponent();
        }

        public StatisticsInfoForm2(DataInterface dataInterface1)
        {
        ...
        private void StatisticsInfoForm2_Load(object sender, EventArgs e)
        {
            //加载时默认选中TabPage1
        ...
        private void currentSelectTabpage2()
        {
            ...
            else  //需要使用滚动条
            {
                ...
                PicWeight.Width = (dataInterface.WeightOrSizeGradeSum - 1) * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) +
                    DrawGraphProtocol.CylinderWidth * 2 + 2 * DrawGraphProtocol.LeftRightSpace + DrawGraphProtocol.Module2RightDistance;
                hScrollBar2.Maximum = PicWeight.Width - tabPage2.Width;
            ...
            {
                bitM2 = new Bitmap(PicWeight.Width, PicWeight.Height);
            ...
            #region 框 柱体1 柱体2 个数 重量
            //"颜色框"字样
            g2.DrawRectangle(new Pen(Color.Black), PicWeight.Width - DrawGraphProtocol.Module2RightDistance, PicWeight.Height / 2 - DrawGraphProtocol.Module2MiddleDistance,
                DrawGraphProtocol.Module2FrameWidth, DrawGraphProtocol.Module2FrameHeight);
            g2.FillRectangle(BarBrush, PicWeight.Width - DrawGraphProtocol.Module2RightDistance + DrawGraphProtocol.Module2SmallGraphHorizontalSpace,
                PicWeight.Height / 2 - DrawGraphProtocol.Module2MiddleDistance + DrawGraphProtocol.Module2SmallGraphVerticalSpace,
                DrawGraphProtocol.Module2SmallCylinderWidth, DrawGraphProtocol.Module2SmallCylinderHeight);
            g2.FillRectangle(BarBrushWeight, PicWeight.Width - DrawGraphProtocol.Module2RightDistance + DrawGraphProtocol.Module2SmallGraphHorizontalSpace,
            ...
            #region 重量名称 （个数|重量）柱体 （个数|重量）个数 （个数|重量）百分比
            //"出口序号"字样  "柱体"图形显示  个数  百分比
            uMaxValueNumber = FunctionInterface.GetMaxValue(dataInterface.IoStStatistics.nGradeCount);
            uSumValueNumber = FunctionInterface.GetSumValue(dataInterface.IoStStatistics.nGradeCount);
            uMaxValueWeight = FunctionInterface.GetMaxValue(dataInterface.IoStStatistics.nWeightGradeCount);
            uSumValueWeight = FunctionInterface.GetSumValue(dataInterface.IoStStatistics.nWeightGradeCount);
            ...
            for (int i = 0; i < dataInterface.WeightOrSizeGradeSum; i++)
            {
                if (bHaveHscrollBar)  //有滚动条时
                {
                    ...
                    g2.DrawString(Encoding.Default.GetString(dataInterface.IoStStGradeInfo.strSizeGradeName, i * ConstPreDefine.MAX_TEXT_LENGTH, ConstPreDefine.MAX_TEXT_LENGTH),
                        ...
                        currentBrush, DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace), PicWeight.Height - DrawGraphProtocol.Module4BottomDistance);

                    if (dataInterface.IoStStatistics.nGradeCount[i] == 0)
                    {
                        //"柱体"个数图形显示
                    ...
                    else
                    {
                        //"柱体"图形显示  个数
                        g2.FillRectangle(BarBrush, DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace),
                        PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - (int)(CylinderHeight2 * ((double)dataInterface.IoStStatistics.nGradeCount[i] / uMaxValueNumber)),
                        DrawGraphProtocol.CylinderWidth, (int)(CylinderHeight2 * ((double)dataInterface.IoStStatistics.nGradeCount[i] / uMaxValueNumber)));
                        //"柱体"重量图形显示
                        g2.FillRectangle(BarBrushWeight, DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.CylinderWidth,
                        PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - (int)(CylinderHeight2 * ((double)dataInterface.IoStStatistics.nWeightGradeCount[i] / uMaxValueWeight)),
                        DrawGraphProtocol.CylinderWidth, (int)(CylinderHeight2 * ((double)dataInterface.IoStStatistics.nWeightGradeCount[i] / uMaxValueWeight)));

                        //显示"个数"值
                        if ((int)(CylinderHeight2 * ((double)dataInterface.IoStStatistics.nGradeCount[i] / uMaxValueNumber)) > DrawGraphProtocol.StandardCylinderHeight)
                        {
                            ...
                            g2.DrawString(dataInterface.IoStStatistics.nGradeCount[i].ToString(),
                                new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
                            g2.ResetTransform();
                        }
                        else
                        {
                            g2.TranslateTransform(DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance,
                            PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance-
                            (int)(CylinderHeight2 * ((double)dataInterface.IoStStatistics.nGradeCount[i] / uMaxValueNumber)));
                            g2.RotateTransform(-90f);
                            g2.DrawString(dataInterface.IoStStatistics.nGradeCount[i].ToString(),
                                new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
                            g2.ResetTransform();
                        ...
                        //显示"重量"值
                        if ((int)(CylinderHeight2 * ((double)dataInterface.IoStStatistics.nWeightGradeCount[i] / uMaxValueWeight)) > DrawGraphProtocol.StandardCylinderHeight)
                        {
                        ...
                        else
                        {
                            g2.TranslateTransform(DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module7CylinderLeftDistance + DrawGraphProtocol.CylinderWidth,
                            PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - DrawGraphProtocol.Module7CylinderBottomDistance-
                            (int)(CylinderHeight2 * ((double)dataInterface.IoStStatistics.nWeightGradeCount[i] / uMaxValueWeight)));
                            g2.RotateTransform(-90f);
                            g2.DrawString(dataInterface.IoStStatistics.nWeightGradeCount[i].ToString(),
                                new Font(DrawGraphProtocol.Module7FontStyle, DrawGraphProtocol.Module7FontSize, FontStyle.Bold), currentBrush, 0, 0);
                            g2.ResetTransform();
                    ...
                    {
                        //"个数"百分比
                        g2.DrawString(((double)dataInterface.IoStStatistics.nGradeCount[i] / uSumValueNumber).ToString("0.00%"),
                            new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush,
                            DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module6LeftDistance,
                            PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - (int)(CylinderHeight2 * ((double)dataInterface.IoStStatistics.nGradeCount[i] / uMaxValueNumber)) - DrawGraphProtocol.Module6CylinderDistance);
                        //"重量"百分比
                        g2.DrawString(((double)dataInterface.IoStStatistics.nWeightGradeCount[i] / uSumValueWeight).ToString("0.00%"),
                            new Font(DrawGraphProtocol.Module6FontStyle, DrawGraphProtocol.Module6FontSize, FontStyle.Regular), currentBrush,
                            DrawGraphProtocol.LeftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace) + DrawGraphProtocol.Module6LeftDistance + DrawGraphProtocol.CylinderWidth,
                            PicWeight.Height - DrawGraphProtocol.Module4BottomDistance - DrawGraphProtocol.Module5FontDistance - (int)(CylinderHeight2 * ((double)dataInterface.IoStStatistics.nWeightGradeCount[i] / uMaxValueWeight)) - DrawGraphProtocol.Module6CylinderDistance);
                    }
                ...
                else  //无滚动条时
                {
                    ...
                    g2.DrawString(Encoding.Default.GetString(dataInterface.IoStStGradeInfo.strSizeGradeName, i * ConstPreDefine.MAX_TEXT_LENGTH, ConstPreDefine.MAX_TEXT_LENGTH), 
                        new Font(DrawGraphProtocol.Module4FontStyle, DrawGraphProtocol.Module4FontSize, FontStyle.Regular),
                        currentBrush, leftRightSpace + i * (DrawGraphProtocol.CylinderWidth * 2 + CurrentDisplayCylinderSpace), PicWeight.Height - DrawGraphProtocol.Module4BottomDistance);
            ...
            PicWeight.BackgroundImage = bitM2;
        }

        private void hScrollBar2_Scroll(object sender, ScrollEventArgs e)
        {
            PicWeight.Left = -hScrollBar2.Value;
        } 
        ...
        private void currentSelectTabpage3()
        {
            ...
            bool bHaveHscrollBar;     //是否有滚动条
            int leftRightSpace = 0;   //柱体离左右边框距离
            Int32 uMaxValue = 0;      //各重量"箱数"最大值
            Int32 uSumValue = 0;      //各重量"箱数"总值
            #endregion
        ...
        private void FillcurrentSelectTabpage4()
        {
            ...
            for (int j = 0; j < dataInterface.WeightOrSizeGradeSum; j++)
            {
                ...
                // LvwSizeOrWeightData.Items[i * dataInterface.WeightOrSizeGradeSum + j].SubItems[1].Text = dataInterface.IoStStGradeInfo.grades[i * ConstPreDefine.MAX_SIZE_GRADE_NUM + j].nMinSize.ToString();
                        ...
                        if (dlg.ShowDialog() == DialogResult.OK)
                        {
                            switch (tabControl1.SelectedIndex)
                            {
                                case 0:
                                    ...
                                    break;
                                case 1:
                                    PicWeight.BackgroundImage.Save(dlg.FileName);
                                    break;
                                case 2:
                            ...
                            MessageBox.Show(LanguageContainer.StatisticsInfoForm2Messagebox3Text[GlobalDataInterface.selectLanguageIndex],
                                LanguageContainer.StatisticsInfoForm2MessageboxInformationCaption[GlobalDataInterface.selectLanguageIndex],
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            try
            {
                ...
                e.Graphics.DrawImage(bitmap,
                    (e.PageBounds.Width - PrintProtocol.leftMargin - PrintProtocol.rightMargin - bitmap.Width) / 2 + PrintProtocol.leftMargin, currentAvailableHeight, bitmap.Width, bitmap.Height);//add by xcw 20201020
            ...
            switch (tabControl1.SelectedIndex)
            {
                case 0:
                    ...
                    string barHead = m_resourceManager.GetString("LblPrintNOrWPercenet.Text");
                ...
                case 1:
                    ...
                    //界面设定
                    if ((dataInterface.WeightOrSizeGradeSum - 1) * (PrintProtocol.cylinderWidth1*2 + PrintProtocol.cylinderSpace1) + PrintProtocol.cylinderWidth1*2+PrintProtocol.ModuleRightDistance < PrintProtocol.barImageWidht)
                    {
                        cylinderWidth = PrintProtocol.cylinderWidth1;
                        cylinderSpace = PrintProtocol.cylinderSpace1;
                        cylinderLeftMargin = (PrintProtocol.barImageWidht - (dataInterface.WeightOrSizeGradeSum - 1) * (PrintProtocol.cylinderWidth1 * 2 + PrintProtocol.cylinderSpace1) - PrintProtocol.cylinderWidth1 * 2 - PrintProtocol.ModuleRightDistance) / 2;
                        cylinderDigitLeftDistance = PrintProtocol.cylinderDigitLeftDistance1;
                    }
                    else
                    {
                        //cylinderWidth = PrintProtocol.cylinderWidth2;
                        //cylinderSpace = PrintProtocol.cylinderSpace2;
                        cylinderWidth = (PrintProtocol.barImageWidht - (dataInterface.WeightOrSizeGradeSum - 1) * 5 - PrintProtocol.ModuleRightDistance) / dataInterface.ExportSum / 2;
                        cylinderSpace = 5;
                        cylinderLeftMargin = (PrintProtocol.barImageWidht - (dataInterface.WeightOrSizeGradeSum - 1) * (cylinderWidth * 2 + cylinderSpace) - cylinderWidth * 2 - PrintProtocol.ModuleRightDistance) / 2;
                        cylinderDigitLeftDistance = PrintProtocol.cylinderDigitLeftDistance2;
                    }
                    //框 柱体1 柱体2 个数 重量(颜色框字样)
                    e.Graphics.DrawRectangle(new Pen(Color.Black), PrintProtocol.barImageWidht - PrintProtocol.ModuleRightDistance, PrintProtocol.barImageHeight / 2 - PrintProtocol.ModuleMiddleDistance,
                    ...
                    e.Graphics.DrawString(m_resourceManager.GetString("LblWeight.Text"), new Font(PrintProtocol.ModuleFontStyle, PrintProtocol.ModuleFontSize, FontStyle.Regular), myCurrentBrush1,
                        PrintProtocol.barImageWidht - PrintProtocol.ModuleRightDistance + PrintProtocol.ModuleSmallGraphHorizontalSpace + PrintProtocol.ModuleSmallCylinderWidth + PrintProtocol.ModuleFontHorizontalSpace,
                        PrintProtocol.barImageHeight / 2 - PrintProtocol.ModuleMiddleDistance + PrintProtocol.ModuleSmallGraphVerticalSpace * 2 + PrintProtocol.ModuleFontVerticalSpace + PrintProtocol.ModuleSmallCylinderHeight);
                    UInt64 uMaxValueNumber1 = FunctionInterface.GetMaxValue(dataInterface.IoStStatistics.nGradeCount);//个数最大值
                    UInt64 uSumValueNumber1 = FunctionInterface.GetSumValue(dataInterface.IoStStatistics.nGradeCount);//个数总值
                    UInt64 uMaxValueWeight1 = FunctionInterface.GetMaxValue(dataInterface.IoStStatistics.nWeightGradeCount);//重量最大值
                    UInt64 uSumValueWeight1 = FunctionInterface.GetSumValue(dataInterface.IoStStatistics.nWeightGradeCount);//重量总值
                    for (int i = 0; i < dataInterface.WeightOrSizeGradeSum; i++)
                    {
                        //柱形图下标字样
                        ...
                        else
                        {
                            //柱形图个数
                            e.Graphics.FillRectangle(myBarBrush1, cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace),
                                PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)dataInterface.IoStStatistics.nGradeCount[i] / uMaxValueNumber1)),
                                cylinderWidth, (int)(PrintProtocol.cylinderMaxHeight * ((double)dataInterface.IoStStatistics.nGradeCount[i] / uMaxValueNumber1)));
                            //柱形图重量
                            e.Graphics.FillRectangle(myBarBrushWeight1, cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth,
                                PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)dataInterface.IoStStatistics.nWeightGradeCount[i] / uMaxValueWeight1)),
                                cylinderWidth, (int)(PrintProtocol.cylinderMaxHeight * ((double)dataInterface.IoStStatistics.nWeightGradeCount[i] / uMaxValueWeight1)));
                            //显示个数值
                            if ((int)(PrintProtocol.cylinderMaxHeight * ((double)dataInterface.IoStStatistics.nGradeCount[i] / uMaxValueNumber1)) > PrintProtocol.cylinderStandardCylinderHeigh)
                            {
                                e.Graphics.TranslateTransform(cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderDigitLeftDistance,
                                    PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - cylinderDigitLeftDistance);
                                e.Graphics.RotateTransform(-90f);
                                e.Graphics.DrawString(dataInterface.IoStStatistics.nGradeCount[i].ToString(),
                            ...
                            {
                                e.Graphics.TranslateTransform(cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderDigitLeftDistance,
                                    PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)dataInterface.IoStStatistics.nGradeCount[i] / uMaxValueNumber1)) - PrintProtocol.cylinderDigitBottomDistance);
                                e.Graphics.RotateTransform(-90f);
                                e.Graphics.DrawString(dataInterface.IoStStatistics.nGradeCount[i].ToString(),
                                    new Font("Times New Roman", 10, FontStyle.Bold), myCurrentBrush1, 0, 0);
                                e.Graphics.ResetTransform();
                            ...
                            //显示重量值
                            if ((int)(PrintProtocol.cylinderMaxHeight * ((double)dataInterface.IoStStatistics.nWeightGradeCount[i] / uMaxValueWeight1)) > PrintProtocol.cylinderStandardCylinderHeigh)
                            {
                                e.Graphics.TranslateTransform(cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth + cylinderDigitLeftDistance,
                                    PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - cylinderDigitLeftDistance);
                                e.Graphics.RotateTransform(-90f);
                            ...
                            {
                                e.Graphics.TranslateTransform(cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth + cylinderDigitLeftDistance,
                                    PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)dataInterface.IoStStatistics.nWeightGradeCount[i] / uMaxValueWeight1)) - PrintProtocol.cylinderDigitBottomDistance);
                                e.Graphics.RotateTransform(-90f);
                                e.Graphics.DrawString(dataInterface.IoStStatistics.nWeightGradeCount[i].ToString(),
                                    new Font("Times New Roman", 10, FontStyle.Bold), myCurrentBrush1, 0, 0);
                                e.Graphics.ResetTransform();
                        ...
                        {
                            //个数百分比
                            e.Graphics.DrawString(((double)dataInterface.IoStStatistics.nGradeCount[i] / uSumValueNumber1).ToString("0.00%"),
                                new Font("Times New Roman", 10, FontStyle.Regular), myCurrentBrush1,
                                cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + PrintProtocol.cylinderPrecentLeftDistance,
                                PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)dataInterface.IoStStatistics.nGradeCount[i] / uMaxValueNumber1)) - PrintProtocol.cylinderPrecentBottomDistance);
                            //重量百分比
                            e.Graphics.DrawString(((double)dataInterface.IoStStatistics.nWeightGradeCount[i] / uSumValueWeight1).ToString("0.00%"),
                                new Font("Times New Roman", 10, FontStyle.Regular), myCurrentBrush1,
                                cylinderLeftMargin + i * (cylinderWidth * 2 + cylinderSpace) + cylinderWidth + PrintProtocol.cylinderPrecentLeftDistance,
                                PrintProtocol.barImageHeight - PrintProtocol.cylinderBottomMargin - (int)(PrintProtocol.cylinderMaxHeight * ((double)dataInterface.IoStStatistics.nWeightGradeCount[i] / uMaxValueWeight1)) - PrintProtocol.cylinderPrecentBottomDistance);
                        }
                    }
                    e.Graphics.ResetTransform();
                    //try
                ...
                case 4:
                    ...
                    //    textContent36, textContentFont3, textContentBrush3, PrintProtocol.leftMargin + PrintProtocol.textContentItemsLeftMargin, currentAvailableHeight);
                    e.Graphics.DrawString(//使用DrawString方法绘制文本子系统字符串
                       textContent40, textContentFont3, textContentBrush3, e.PageBounds.Width/2 /*PrintProtocol.leftMargin + PrintProtocol.textContentItemsLeftMargin + PrintProtocol.textContentItemsWidth2+50*/, currentAvailableHeight);
                    #endregion
        ...
        private void ExportExcelbutton_Click(object sender, EventArgs e)
        {
            ...
            if (dlg.ShowDialog() == DialogResult.OK)
            {
                ...
                if (File.Exists)
                {
                    ...
                    DialogResult result = MessageBox.Show("0x30001021 " + LanguageContainer.StatisticsInfoForm2Messagebox1Text[GlobalDataInterface.selectLanguageIndex],
                        LanguageContainer.StatisticsInfoForm2MessageboxInformationCaption[GlobalDataInterface.selectLanguageIndex], 
                ...
                //ExcelReportFunc.CreateExcel(dlg.FileName, dataInterface,false,false);
                //MessageBox.Show("Export excel report successfully!");
                MessageBox.Show(LanguageContainer.StatisticsInfoForm2Messagebox2Text[GlobalDataInterface.selectLanguageIndex],
                                LanguageContainer.StatisticsInfoForm2MessageboxInformationCaption[GlobalDataInterface.selectLanguageIndex],
                                MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        private void StatisticsInfoForm2_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                GlobalDataInterface.UpdateDataInterfaceEvent -= new GlobalDataInterface.DataInterfaceEventHandler(OnUpdateDataInterfaceEvent);
            ...
            {
#if REALEASE
                GlobalDataInterface.WriteErrorInfo("StatisticsInfoForm2_FormClosing出错: " + ex.StackTrace);
#endif
            }
        }      
